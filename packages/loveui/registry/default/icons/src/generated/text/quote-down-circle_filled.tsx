...
export interface QuoteDownCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const QuoteDownCircleFilled = React.forwardRef<SVGSVGElement, QuoteDownCircleFilledProps>(
...
QuoteDownCircleFilled.displayName = "QuoteDownCircleFilled";
export const QuoteDownCircleFilledMetadata = { 
  id: "quote-down-circle_filled", 
...
export default QuoteDownCircleFilled;
