...
export interface VideoRemoveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VideoRemoveFilled = React.forwardRef<SVGSVGElement, VideoRemoveFilledProps>(
...
<path d="M7.24998 2.01997C4.68998 2.17997 2.93998 3.49997 2.28998 5.69997C2.18998 6.02997 2.42998 6.35997 2.76998 6.35997H7.26998C7.54998 6.35997 7.76998 6.13997 7.76998 5.85997V2.51997C7.76998 2.23997 7.52998 1.99997 7.24998 2.01997Z" fill="currentColor"/>
<path d="M16.75 2.00996C19.31 2.16996 21.06 3.48996 21.71 5.68996C21.81 6.01996 21.57 6.34996 21.23 6.34996H16.73C16.45 6.34996 16.23 6.12996 16.23 5.84996V2.50996C16.23 2.22996 16.47 1.98996 16.75 2.00996Z" fill="currentColor"/>
<path d="M22 8.36011V12.7401C22 13.1101 21.61 13.3501 21.28 13.1801C20.44 12.7401 19.48 12.5001 18.5 12.5001C16.89 12.5001 15.32 13.1601 14.2 14.3101C13.1 15.4301 12.5 16.9201 12.5 18.5001C12.5 19.3101 12.82 20.3501 13.22 21.2201C13.38 21.5701 13.14 22.0001 12.75 22.0001H7.81C4.6 22.0001 2 19.4001 2 16.1901V8.36011C2 8.08011 2.22 7.86011 2.5 7.86011H21.5C21.78 7.86011 22 8.08011 22 8.36011Z" fill="currentColor"/>
    </svg>
  )
);
VideoRemoveFilled.displayName = "VideoRemoveFilled";
export const VideoRemoveFilledMetadata = { 
  id: "video-remove_filled", 
  baseId: "video-remove", 
  variant: "filled", 
  name: "Video Remove", 
  category: "multimedia", 
...
export default VideoRemoveFilled;
