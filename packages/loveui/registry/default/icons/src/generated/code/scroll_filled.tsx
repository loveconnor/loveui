...
export interface ScrollFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ScrollFilled = React.forwardRef<SVGSVGElement, ScrollFilledProps>(
...
ScrollFilled.displayName = "ScrollFilled";
export const ScrollFilledMetadata = { 
  id: "scroll_filled", 
  baseId: "scroll", 
  variant: "filled", 
  name: "Scroll", 
