...
export interface MusicSquareAddFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MusicSquareAddFilled = React.forwardRef<SVGSVGElement, MusicSquareAddFilledProps>(
...
MusicSquareAddFilled.displayName = "MusicSquareAddFilled";
export const MusicSquareAddFilledMetadata = { 
  id: "music-square-add_filled", 
...
export default MusicSquareAddFilled;
