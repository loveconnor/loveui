...
export interface BluetoothCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BluetoothCircleFilled = React.forwardRef<SVGSVGElement, BluetoothCircleFilledProps>(
...
BluetoothCircleFilled.displayName = "BluetoothCircleFilled";
export const BluetoothCircleFilledMetadata = { 
  id: "bluetooth-circle_filled", 
