...
export interface Tag2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Tag2Filled = React.forwardRef<SVGSVGElement, Tag2FilledProps>(
