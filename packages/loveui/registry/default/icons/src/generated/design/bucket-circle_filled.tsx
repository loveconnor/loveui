...
export interface BucketCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BucketCircleFilled = React.forwardRef<SVGSVGElement, BucketCircleFilledProps>(
...
BucketCircleFilled.displayName = "BucketCircleFilled";
export const BucketCircleFilledMetadata = { 
  id: "bucket-circle_filled", 
...
export default BucketCircleFilled;
