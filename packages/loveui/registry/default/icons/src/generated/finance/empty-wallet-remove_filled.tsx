...
export interface EmptyWalletRemoveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EmptyWalletRemoveFilled = React.forwardRef<SVGSVGElement, EmptyWalletRemoveFilledProps>(
...
EmptyWalletRemoveFilled.displayName = "EmptyWalletRemoveFilled";
export const EmptyWalletRemoveFilledMetadata = { 
  id: "empty-wallet-remove_filled", 
...
export default EmptyWalletRemoveFilled;
