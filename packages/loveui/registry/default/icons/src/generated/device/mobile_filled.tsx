...
export interface MobileFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MobileFilled = React.forwardRef<SVGSVGElement, MobileFilledProps>(
...
export const MobileFilledMetadata = { 
  id: "mobile_filled", 
  baseId: "mobile", 
  variant: "filled", 
  name: "Mobile", 
