...
export interface PlaystationProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Playstation = React.forwardRef<SVGSVGElement, PlaystationProps>(
...
export const PlaystationMetadata = {
  id: "Playstation",
  baseId: "Playstation",
  variant: "default",
  name: "Playstation",
