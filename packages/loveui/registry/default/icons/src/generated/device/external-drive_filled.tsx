...
export interface ExternalDriveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ExternalDriveFilled = React.forwardRef<SVGSVGElement, ExternalDriveFilledProps>(
...
ExternalDriveFilled.displayName = "ExternalDriveFilled";
export const ExternalDriveFilledMetadata = { 
  id: "external-drive_filled", 
...
export default ExternalDriveFilled;
