...
const data: UsageItem[] = [
  { label: "Blocks", amount: 450, percentage: 52.3, color: "emerald" },
  { label: "Components", amount: 285, percentage: 33.1, color: "amber" },
  { label: "Docs", amount: 125, percentage: 14.6, color: "rose" },
];
        ...
        <CardContent className="flex flex-col justify-between pt-0">
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-balance text-sm font-bold text-foreground">LoveUI usage</h3>
              <Badge
                variant="secondary"
            ...
            <p className="text-pretty mt-2 flex items-baseline gap-2">
              ...
              <span className="text-sm text-muted-foreground">installs this month</span>
            </p>
