...
export interface CallSlashFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CallSlashFilled = React.forwardRef<SVGSVGElement, CallSlashFilledProps>(
...
CallSlashFilled.displayName = "CallSlashFilled";
export const CallSlashFilledMetadata = { 
  id: "call-slash_filled", 
  baseId: "call-slash", 
  variant: "filled", 
  name: "Call Slash", 
...
export default CallSlashFilled;
