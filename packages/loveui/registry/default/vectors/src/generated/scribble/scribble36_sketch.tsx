...
export interface Scribble36SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble36Sketch = React.forwardRef<SVGSVGElement, Scribble36SketchProps>(
...
export default Scribble36Sketch;
