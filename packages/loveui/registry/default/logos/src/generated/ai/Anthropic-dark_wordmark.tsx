...
export interface AnthropicDarkWordmarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const AnthropicDarkWordmark = React.forwardRef<SVGSVGElement, AnthropicDarkWordmarkProps>(
...
AnthropicDarkWordmark.displayName = "AnthropicDarkWordmark";

export const AnthropicDarkWordmarkMetadata = {
  id: "Anthropic-dark_wordmark",
  baseId: "Anthropic-dark",
  variant: "wordmark",
  name: "Anthropic Dark",
  category: "ai",
  tags: [],
...
export default AnthropicDarkWordmark;
