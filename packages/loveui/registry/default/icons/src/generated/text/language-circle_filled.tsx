...
export interface LanguageCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LanguageCircleFilled = React.forwardRef<SVGSVGElement, LanguageCircleFilledProps>(
...
LanguageCircleFilled.displayName = "LanguageCircleFilled";
export const LanguageCircleFilledMetadata = { 
  id: "language-circle_filled", 
...
export default LanguageCircleFilled;
