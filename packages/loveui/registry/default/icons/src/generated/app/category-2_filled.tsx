...
export interface Category2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Category2Filled = React.forwardRef<SVGSVGElement, Category2FilledProps>(
...
<path d="M17.71 21.9999C20.0793 21.9999 22 20.0792 22 17.7099C22 15.3406 20.0793 13.4199 17.71 13.4199C15.3407 13.4199 13.42 15.3406 13.42 17.7099C13.42 20.0792 15.3407 21.9999 17.71 21.9999Z" fill="currentColor"/>
    </svg>
  )
);
Category2Filled.displayName = "Category2Filled";
export const Category2FilledMetadata = { 
  id: "category-2_filled", 
  baseId: "category-2", 
  variant: "filled", 
  name: "Category 2", 
  category: "app", 
...
export default Category2Filled;
