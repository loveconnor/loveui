...
export interface TextItalicFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TextItalicFilled = React.forwardRef<SVGSVGElement, TextItalicFilledProps>(
...
export const TextItalicFilledMetadata = { 
  id: "text-italic_filled", 
  baseId: "text-italic", 
  variant: "filled", 
  name: "Text Italic", 
  category: "text", 
