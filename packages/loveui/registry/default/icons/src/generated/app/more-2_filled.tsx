...
export interface More2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const More2Filled = React.forwardRef<SVGSVGElement, More2FilledProps>(
...
More2Filled.displayName = "More2Filled";
export const More2FilledMetadata = { 
  id: "more-2_filled", 
  baseId: "more-2", 
  variant: "filled", 
  name: "More 2", 
