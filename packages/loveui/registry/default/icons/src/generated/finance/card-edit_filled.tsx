...
export interface CardEditFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CardEditFilled = React.forwardRef<SVGSVGElement, CardEditFilledProps>(
...
CardEditFilled.displayName = "CardEditFilled";
export const CardEditFilledMetadata = { 
  id: "card-edit_filled", 
  baseId: "card-edit", 
  variant: "filled", 
  name: "Card Edit", 
