...
export interface ReceiptSearchFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptSearchFilled = React.forwardRef<SVGSVGElement, ReceiptSearchFilledProps>(
...
ReceiptSearchFilled.displayName = "ReceiptSearchFilled";
export const ReceiptSearchFilledMetadata = { 
  id: "receipt-search_filled", 
