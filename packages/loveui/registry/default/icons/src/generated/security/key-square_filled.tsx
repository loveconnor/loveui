...
export interface KeySquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const KeySquareFilled = React.forwardRef<SVGSVGElement, KeySquareFilledProps>(
...
KeySquareFilled.displayName = "KeySquareFilled";
export const KeySquareFilledMetadata = { 
  id: "key-square_filled", 
  baseId: "key-square", 
  variant: "filled", 
  name: "Key Square", 
  category: "security", 
...
export default KeySquareFilled;
