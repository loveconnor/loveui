...
export interface Notification1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Notification1Filled = React.forwardRef<SVGSVGElement, Notification1FilledProps>(
...
Notification1Filled.displayName = "Notification1Filled";
export const Notification1FilledMetadata = { 
  id: "notification-1_filled", 
...
export default Notification1Filled;
