...
export interface ElementEqualFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ElementEqualFilled = React.forwardRef<SVGSVGElement, ElementEqualFilledProps>(
...
ElementEqualFilled.displayName = "ElementEqualFilled";
export const ElementEqualFilledMetadata = { 
  id: "element-equal_filled", 
...
export default ElementEqualFilled;
