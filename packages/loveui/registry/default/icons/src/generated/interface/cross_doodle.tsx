...
export interface CrossDoodleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CrossDoodle = React.forwardRef<SVGSVGElement, CrossDoodleProps>(
...
<defs>
<clipPath id="clip0">
<rect width="129" height="127" fill="currentColor" transform="translate(0.777344)"/>
</clipPath>
</defs>
    </svg>
  )
);
CrossDoodle.displayName = "CrossDoodle";
export const CrossDoodleMetadata = { 
  id: "cross_doodle", 
  baseId: "cross", 
  variant: "doodle", 
  name: "Cross", 
