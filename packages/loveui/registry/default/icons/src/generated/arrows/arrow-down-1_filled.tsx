...
export interface ArrowDown1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowDown1Filled = React.forwardRef<SVGSVGElement, ArrowDown1FilledProps>(
...
ArrowDown1Filled.displayName = "ArrowDown1Filled";
export const ArrowDown1FilledMetadata = { 
  id: "arrow-down-1_filled", 
  baseId: "arrow-down-1", 
  variant: "filled", 
  name: "Arrow Down 1", 
  category: "arrows", 
...
export default ArrowDown1Filled;
