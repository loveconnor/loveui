...
export interface Refresh2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Refresh2Filled = React.forwardRef<SVGSVGElement, Refresh2FilledProps>(
...
Refresh2Filled.displayName = "Refresh2Filled";
export const Refresh2FilledMetadata = { 
  id: "refresh-2_filled", 
  baseId: "refresh-2", 
  variant: "filled", 
  name: "Refresh 2", 
