...
export interface DocumentCloudFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DocumentCloudFilled = React.forwardRef<SVGSVGElement, DocumentCloudFilledProps>(
...
<path d="M14.76 19.2601C12.41 19.4301 12.41 22.8301 14.76 23.0001H20.32C20.99 23.0001 21.65 22.7501 22.14 22.3001C23.79 20.8601 22.91 17.9801 20.74 17.7101C19.96 13.0201 13.18 14.8001 14.78 19.2701" fill="currentColor"/>
...
DocumentCloudFilled.displayName = "DocumentCloudFilled";
export const DocumentCloudFilledMetadata = { 
  id: "document-cloud_filled", 
...
export default DocumentCloudFilled;
