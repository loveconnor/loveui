...
export interface CreativeCommonsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CreativeCommonsFilled = React.forwardRef<SVGSVGElement, CreativeCommonsFilledProps>(
...
CreativeCommonsFilled.displayName = "CreativeCommonsFilled";
export const CreativeCommonsFilledMetadata = { 
  id: "creative-commons_filled", 
...
export default CreativeCommonsFilled;
