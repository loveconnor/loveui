...
export interface Receipt21FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Receipt21Filled = React.forwardRef<SVGSVGElement, Receipt21FilledProps>(
...
Receipt21Filled.displayName = "Receipt21Filled";
export const Receipt21FilledMetadata = { 
  id: "receipt-2-1_filled", 
  baseId: "receipt-2-1", 
  variant: "filled", 
  name: "Receipt 2 1", 
  category: "finance", 
...
export default Receipt21Filled;
