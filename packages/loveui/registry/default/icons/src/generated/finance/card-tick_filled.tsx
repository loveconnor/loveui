...
export interface CardTickFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CardTickFilled = React.forwardRef<SVGSVGElement, CardTickFilledProps>(
...
CardTickFilled.displayName = "CardTickFilled";
export const CardTickFilledMetadata = { 
  id: "card-tick_filled", 
  baseId: "card-tick", 
  variant: "filled", 
  name: "Card Tick", 
