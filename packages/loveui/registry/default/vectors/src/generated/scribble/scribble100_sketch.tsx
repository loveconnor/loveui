...
export interface Scribble100SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble100Sketch = React.forwardRef<SVGSVGElement, Scribble100SketchProps>(
...
export default Scribble100Sketch;
