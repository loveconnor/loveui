...
export interface TruckTimeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TruckTimeFilled = React.forwardRef<SVGSVGElement, TruckTimeFilledProps>(
...
TruckTimeFilled.displayName = "TruckTimeFilled";
export const TruckTimeFilledMetadata = { 
  id: "truck-time_filled", 
  baseId: "truck-time", 
  variant: "filled", 
  name: "Truck Time", 
  category: "commerce", 
...
export default TruckTimeFilled;
