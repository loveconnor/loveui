...
export interface CardRemoveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CardRemoveFilled = React.forwardRef<SVGSVGElement, CardRemoveFilledProps>(
...
CardRemoveFilled.displayName = "CardRemoveFilled";
export const CardRemoveFilledMetadata = { 
  id: "card-remove_filled", 
  baseId: "card-remove", 
  variant: "filled", 
  name: "Card Remove", 
  category: "finance", 
...
export default CardRemoveFilled;
