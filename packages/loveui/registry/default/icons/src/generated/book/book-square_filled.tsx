...
export interface BookSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BookSquareFilled = React.forwardRef<SVGSVGElement, BookSquareFilledProps>(
...
BookSquareFilled.displayName = "BookSquareFilled";
export const BookSquareFilledMetadata = { 
  id: "book-square_filled", 
  baseId: "book-square", 
  variant: "filled", 
  name: "Book Square", 
  category: "book", 
...
export default BookSquareFilled;
