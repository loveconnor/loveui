...
export interface CloudCrossFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CloudCrossFilled = React.forwardRef<SVGSVGElement, CloudCrossFilledProps>(
...
CloudCrossFilled.displayName = "CloudCrossFilled";
export const CloudCrossFilledMetadata = { 
  id: "cloud-cross_filled", 
  baseId: "cloud-cross", 
  variant: "filled", 
  name: "Cloud Cross", 
  category: "weather", 
...
export default CloudCrossFilled;
