...
export interface ConvertFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ConvertFilled = React.forwardRef<SVGSVGElement, ConvertFilledProps>(
...
ConvertFilled.displayName = "ConvertFilled";
export const ConvertFilledMetadata = { 
  id: "convert_filled", 
  baseId: "convert", 
  variant: "filled", 
  name: "Convert", 
