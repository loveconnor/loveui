...
export interface VideoTimeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VideoTimeFilled = React.forwardRef<SVGSVGElement, VideoTimeFilledProps>(
...
VideoTimeFilled.displayName = "VideoTimeFilled";
export const VideoTimeFilledMetadata = { 
  id: "video-time_filled", 
  baseId: "video-time", 
  variant: "filled", 
  name: "Video Time", 
  category: "multimedia", 
...
export default VideoTimeFilled;
