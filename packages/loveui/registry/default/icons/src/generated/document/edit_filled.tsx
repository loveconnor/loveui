...
export interface EditFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EditFilled = React.forwardRef<SVGSVGElement, EditFilledProps>(
...
export const EditFilledMetadata = { 
  id: "edit_filled", 
  baseId: "edit", 
  variant: "filled", 
  name: "Edit", 
