...
export interface HierarchyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HierarchyFilled = React.forwardRef<SVGSVGElement, HierarchyFilledProps>(
...
HierarchyFilled.displayName = "HierarchyFilled";
export const HierarchyFilledMetadata = { 
  id: "hierarchy_filled", 
  baseId: "hierarchy", 
  variant: "filled", 
  name: "Hierarchy", 
...
export default HierarchyFilled;
