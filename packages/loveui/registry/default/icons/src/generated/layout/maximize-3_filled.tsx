...
export interface Maximize3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Maximize3Filled = React.forwardRef<SVGSVGElement, Maximize3FilledProps>(
...
Maximize3Filled.displayName = "Maximize3Filled";
export const Maximize3FilledMetadata = { 
  id: "maximize-3_filled", 
  baseId: "maximize-3", 
  variant: "filled", 
  name: "Maximize 3", 
  category: "layout", 
...
export default Maximize3Filled;
