...
export interface Lock1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Lock1Filled = React.forwardRef<SVGSVGElement, Lock1FilledProps>(
...
Lock1Filled.displayName = "Lock1Filled";
export const Lock1FilledMetadata = { 
  id: "lock-1_filled", 
  baseId: "lock-1", 
  variant: "filled", 
  name: "Lock 1", 
