...
export interface DocumentPreviousFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DocumentPreviousFilled = React.forwardRef<SVGSVGElement, DocumentPreviousFilledProps>(
...
DocumentPreviousFilled.displayName = "DocumentPreviousFilled";
export const DocumentPreviousFilledMetadata = { 
  id: "document-previous_filled", 
...
export default DocumentPreviousFilled;
