...
export interface ArrangeCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrangeCircleFilled = React.forwardRef<SVGSVGElement, ArrangeCircleFilledProps>(
...
ArrangeCircleFilled.displayName = "ArrangeCircleFilled";
export const ArrangeCircleFilledMetadata = { 
  id: "arrange-circle_filled", 
...
export default ArrangeCircleFilled;
