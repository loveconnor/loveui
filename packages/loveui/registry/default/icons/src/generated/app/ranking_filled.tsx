...
export interface RankingFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RankingFilled = React.forwardRef<SVGSVGElement, RankingFilledProps>(
