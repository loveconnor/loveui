...
export interface MiniMusicSqaureFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MiniMusicSqaureFilled = React.forwardRef<SVGSVGElement, MiniMusicSqaureFilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path opacity="0.4" d="M20.71 17.52C20.34 18.74 19.61 19.68 18.57 20.26C18.53 20.1 18.51 19.93 18.51 19.76C18.51 18.54 19.5 17.54 20.71 17.52Z" fill="currentColor"/>
<path d="M21 7.52V9.48397C21 10.0065 20.586 10.4294 20.08 10.56L17.13 11.38C15.57 11.78 14.53 13.13 14.53 14.74V16.2849C14.53 16.7595 14.1873 17.1556 13.7612 17.3644C12.7457 17.8619 11.9698 18.8714 11.677 20.0107C11.5395 20.5456 11.1023 21 10.55 21H7.52C4.07 21 2 18.94 2 15.48V7.52C2 4.06 4.07 2 7.52 2H15.48C18.93 2 21 4.06 21 7.52Z" fill="currentColor"/>
...
MiniMusicSqaureFilled.displayName = "MiniMusicSqaureFilled";
export const MiniMusicSqaureFilledMetadata = { 
  id: "mini-music-sqaure_filled", 
...
export default MiniMusicSqaureFilled;
