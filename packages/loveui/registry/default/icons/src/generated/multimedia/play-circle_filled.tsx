...
export interface PlayCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PlayCircleFilled = React.forwardRef<SVGSVGElement, PlayCircleFilledProps>(
...
export const PlayCircleFilledMetadata = { 
  id: "play-circle_filled", 
  baseId: "play-circle", 
  variant: "filled", 
  name: "Play Circle", 
  category: "multimedia", 
