...
export interface RulerFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RulerFilled = React.forwardRef<SVGSVGElement, RulerFilledProps>(
...
RulerFilled.displayName = "RulerFilled";
export const RulerFilledMetadata = { 
  id: "ruler_filled", 
  baseId: "ruler", 
  variant: "filled", 
  name: "Ruler", 
