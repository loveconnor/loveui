...
export interface QuoteUpCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const QuoteUpCircleFilled = React.forwardRef<SVGSVGElement, QuoteUpCircleFilledProps>(
...
QuoteUpCircleFilled.displayName = "QuoteUpCircleFilled";
export const QuoteUpCircleFilledMetadata = { 
  id: "quote-up-circle_filled", 
...
export default QuoteUpCircleFilled;
