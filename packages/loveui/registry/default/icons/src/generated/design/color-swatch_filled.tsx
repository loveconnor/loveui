...
export interface ColorSwatchFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ColorSwatchFilled = React.forwardRef<SVGSVGElement, ColorSwatchFilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M22 16.5V19.5C22 20.88 20.88 22 19.5 22H12.36C11.47 22 11.03 20.93 11.65 20.3L17.52 14.3C17.71 14.11 17.97 14 18.23 14H19.5C20.88 14 22 15.12 22 16.5Z" fill="currentColor"/>
<path d="M18.37 11.29L15.66 14L13.2 16.45C12.57 17.08 11.49 16.64 11.49 15.75C11.49 12.54 11.49 7.26002 11.49 7.26002C11.49 6.99002 11.6 6.74002 11.78 6.55002L12.7 5.63002C13.68 4.65002 15.26 4.65002 16.24 5.63002L18.36 7.75002C19.35 8.73002 19.35 10.31 18.37 11.29Z" fill="currentColor"/>
...
ColorSwatchFilled.displayName = "ColorSwatchFilled";
export const ColorSwatchFilledMetadata = { 
  id: "color-swatch_filled", 
  baseId: "color-swatch", 
  variant: "filled", 
  name: "Color Swatch", 
  category: "design", 
...
export default ColorSwatchFilled;
