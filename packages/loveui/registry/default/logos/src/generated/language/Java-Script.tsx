...
export interface JavaScriptProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const JavaScript = React.forwardRef<SVGSVGElement, JavaScriptProps>(
...
export const JavaScriptMetadata = {
  id: "Java-Script",
  baseId: "Java-Script",
  variant: "default",
  name: "Java Script",
