...
export interface Edit2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Edit2Filled = React.forwardRef<SVGSVGElement, Edit2FilledProps>(
