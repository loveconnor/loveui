...
export interface SmileysFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SmileysFilled = React.forwardRef<SVGSVGElement, SmileysFilledProps>(
...
<path d="M18.22 16.6801C18.15 16.6001 18.05 16.5601 17.94 16.5601H14.06C13.95 16.5601 13.85 16.6001 13.78 16.6801C13.71 16.7601 13.67 16.8701 13.69 16.9701C13.82 18.1501 14.81 19.0501 16 19.0501C17.19 19.0501 18.18 18.1601 18.31 16.9701C18.32 16.8601 18.29 16.7601 18.22 16.6801Z" fill="currentColor"/>
...
SmileysFilled.displayName = "SmileysFilled";
export const SmileysFilledMetadata = { 
  id: "smileys_filled", 
  baseId: "smileys", 
  variant: "filled", 
  name: "Smileys", 
