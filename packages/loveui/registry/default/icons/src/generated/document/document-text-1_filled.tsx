...
export interface DocumentText1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DocumentText1Filled = React.forwardRef<SVGSVGElement, DocumentText1FilledProps>(
...
DocumentText1Filled.displayName = "DocumentText1Filled";
export const DocumentText1FilledMetadata = { 
  id: "document-text-1_filled", 
...
export default DocumentText1Filled;
