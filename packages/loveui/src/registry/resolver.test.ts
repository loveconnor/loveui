...
describe("resolveRegistryItemsFromRegistries", () => {
  ...
  it("should handle mixed registry and non-registry items", () => {
    ...
    // Non-registry items (button, dialog) are resolved through the built-in @love-ui registry
    expect(result).toEqual([
      "https://www.loveui.dev/r/button.json",
      "https://v0.dev/chat/b/card/json",
      "https://www.loveui.dev/r/dialog.json",
