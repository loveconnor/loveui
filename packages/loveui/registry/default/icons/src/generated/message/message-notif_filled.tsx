...
export interface MessageNotifFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MessageNotifFilled = React.forwardRef<SVGSVGElement, MessageNotifFilledProps>(
...
MessageNotifFilled.displayName = "MessageNotifFilled";
export const MessageNotifFilledMetadata = { 
  id: "message-notif_filled", 
...
export default MessageNotifFilled;
