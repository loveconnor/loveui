...
export interface DirectFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DirectFilled = React.forwardRef<SVGSVGElement, DirectFilledProps>(
...
DirectFilled.displayName = "DirectFilled";
export const DirectFilledMetadata = { 
  id: "direct_filled", 
  baseId: "direct", 
  variant: "filled", 
  name: "Direct", 
