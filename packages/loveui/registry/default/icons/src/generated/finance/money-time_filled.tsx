...
export interface MoneyTimeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MoneyTimeFilled = React.forwardRef<SVGSVGElement, MoneyTimeFilledProps>(
...
MoneyTimeFilled.displayName = "MoneyTimeFilled";
export const MoneyTimeFilledMetadata = { 
  id: "money-time_filled", 
  baseId: "money-time", 
  variant: "filled", 
  name: "Money Time", 
  category: "finance", 
...
export default MoneyTimeFilled;
