...
export interface UserMinusFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const UserMinusFilled = React.forwardRef<SVGSVGElement, UserMinusFilledProps>(
...
export const UserMinusFilledMetadata = { 
  id: "user-minus_filled", 
  baseId: "user-minus", 
  variant: "filled", 
  name: "User Minus", 
  category: "user", 
