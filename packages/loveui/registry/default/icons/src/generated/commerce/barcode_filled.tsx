...
export interface BarcodeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BarcodeFilled = React.forwardRef<SVGSVGElement, BarcodeFilledProps>(
...
BarcodeFilled.displayName = "BarcodeFilled";
export const BarcodeFilledMetadata = { 
  id: "barcode_filled", 
  baseId: "barcode", 
  variant: "filled", 
  name: "Barcode", 
