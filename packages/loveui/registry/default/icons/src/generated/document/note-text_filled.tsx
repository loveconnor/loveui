...
export interface NoteTextFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const NoteTextFilled = React.forwardRef<SVGSVGElement, NoteTextFilledProps>(
...
export const NoteTextFilledMetadata = { 
  id: "note-text_filled", 
  baseId: "note-text", 
  variant: "filled", 
  name: "Note Text", 
