...
export interface LinkCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LinkCircleFilled = React.forwardRef<SVGSVGElement, LinkCircleFilledProps>(
...
LinkCircleFilled.displayName = "LinkCircleFilled";
export const LinkCircleFilledMetadata = { 
  id: "link-circle_filled", 
  baseId: "link-circle", 
  variant: "filled", 
  name: "Link Circle", 
  category: "text", 
...
export default LinkCircleFilled;
