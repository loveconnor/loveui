...
export interface PresentionChartFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PresentionChartFilled = React.forwardRef<SVGSVGElement, PresentionChartFilledProps>(
...
PresentionChartFilled.displayName = "PresentionChartFilled";
export const PresentionChartFilledMetadata = { 
  id: "presention-chart_filled", 
...
export default PresentionChartFilled;
