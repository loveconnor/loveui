...
export interface BezierFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BezierFilled = React.forwardRef<SVGSVGElement, BezierFilledProps>(
...
BezierFilled.displayName = "BezierFilled";
export const BezierFilledMetadata = { 
  id: "bezier_filled", 
  baseId: "bezier", 
  variant: "filled", 
  name: "Bezier", 
