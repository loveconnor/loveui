...
export interface ElementPlusFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ElementPlusFilled = React.forwardRef<SVGSVGElement, ElementPlusFilledProps>(
...
ElementPlusFilled.displayName = "ElementPlusFilled";
export const ElementPlusFilledMetadata = { 
  id: "element-plus_filled", 
  baseId: "element-plus", 
  variant: "filled", 
  name: "Element Plus", 
  category: "layout", 
...
export default ElementPlusFilled;
