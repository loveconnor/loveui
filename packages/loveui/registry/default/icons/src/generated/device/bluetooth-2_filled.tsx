...
export interface Bluetooth2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Bluetooth2Filled = React.forwardRef<SVGSVGElement, Bluetooth2FilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M12.3 17.3198L14.61 15.3898L12.3 13.2998V17.3198Z" fill="currentColor"/>
<path d="M12.3 6.68018V10.6402L14.61 8.52018L12.3 6.68018Z" fill="currentColor"/>
...
Bluetooth2Filled.displayName = "Bluetooth2Filled";
export const Bluetooth2FilledMetadata = { 
  id: "bluetooth-2_filled", 
  baseId: "bluetooth-2", 
  variant: "filled", 
  name: "Bluetooth 2", 
  category: "device", 
...
export default Bluetooth2Filled;
