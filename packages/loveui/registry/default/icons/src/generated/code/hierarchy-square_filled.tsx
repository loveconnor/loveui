...
export interface HierarchySquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HierarchySquareFilled = React.forwardRef<SVGSVGElement, HierarchySquareFilledProps>(
...
HierarchySquareFilled.displayName = "HierarchySquareFilled";
export const HierarchySquareFilledMetadata = { 
  id: "hierarchy-square_filled", 
...
export default HierarchySquareFilled;
