...
const defaultSegments: NonNullable<Props["segments"]> = [
  { label: "Blocks", value: 2400, color: "bg-blue-500" },
  { label: "Components", value: 1800, color: "bg-emerald-500" },
  { label: "Examples", value: 3200, color: "bg-amber-500" },
  { label: "Docs", value: 900, color: "bg-purple-500" },
];

export default function Stats13({
  title = "Using LoveUI assets",
  used = 8300,
  total = 15,
  usedLabel = "MB",
  totalLabel = "GB",
