...
export interface MoneyRemoveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MoneyRemoveFilled = React.forwardRef<SVGSVGElement, MoneyRemoveFilledProps>(
...
MoneyRemoveFilled.displayName = "MoneyRemoveFilled";
export const MoneyRemoveFilledMetadata = { 
  id: "money-remove_filled", 
  baseId: "money-remove", 
  variant: "filled", 
  name: "Money Remove", 
  category: "finance", 
...
export default MoneyRemoveFilled;
