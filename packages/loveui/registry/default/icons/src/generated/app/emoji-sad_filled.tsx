...
export interface EmojiSadFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EmojiSadFilled = React.forwardRef<SVGSVGElement, EmojiSadFilledProps>(
...
EmojiSadFilled.displayName = "EmojiSadFilled";
export const EmojiSadFilledMetadata = { 
  id: "emoji-sad_filled", 
  baseId: "emoji-sad", 
  variant: "filled", 
  name: "Emoji Sad", 
