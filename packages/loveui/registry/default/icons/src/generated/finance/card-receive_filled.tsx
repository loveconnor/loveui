...
export interface CardReceiveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CardReceiveFilled = React.forwardRef<SVGSVGElement, CardReceiveFilledProps>(
...
CardReceiveFilled.displayName = "CardReceiveFilled";
export const CardReceiveFilledMetadata = { 
  id: "card-receive_filled", 
  baseId: "card-receive", 
  variant: "filled", 
  name: "Card Receive", 
  category: "finance", 
...
export default CardReceiveFilled;
