...
export interface Warning2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Warning2Filled = React.forwardRef<SVGSVGElement, Warning2FilledProps>(
