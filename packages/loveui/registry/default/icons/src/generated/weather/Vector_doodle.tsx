...
export interface VectorDoodleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VectorDoodle = React.forwardRef<SVGSVGElement, VectorDoodleProps>(
