...
export interface CzechiaSymbolsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const CzechiaSymbols = React.forwardRef<SVGSVGElement, CzechiaSymbolsProps>(
...
CzechiaSymbols.displayName = "CzechiaSymbols";

export const CzechiaSymbolsMetadata = {
  id: "Czechia_symbols",
  baseId: "Czechia",
  variant: "symbols",
  name: "Czechia",
