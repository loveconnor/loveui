...
`;function L(e){if(!e)return e;let o=e.split("/");return o[o.length-1]||e}function ce(e){let o=e.trim();return o&&((o.startsWith("@/")||o.startsWith("~/"))&&(o=`src/${o.slice(2)}`),o.startsWith("/")&&(o=o.slice(1)),o=o.replace(/^\.\//,""),o=o.replace(/\/+$/,""),o)}function Pe(e){return e.trim().replace(/\/+$/,"")}function T(e){return e.replace(/\.(?:ts|tsx|js|jsx)$/i,"")}function Q(e){let o=T(e);return we.map(s=>`${o}${s}`)}function De(e){let o=e.replace(/\/+$/,"");return o==="src"||o.startsWith("src/")?"src":o==="app"||o.startsWith("app/")?"app":null}function ue(e){let o=L(e);return o==="ui"?"love-ui":o}function Se(e){let o=e.loveui??{},s=typeof o.target=="string"?o.target.trim():"",t=o.category;if(s){let i=typeof o.includePackageName=="boolean"?o.includePackageName:!1;return{base:s.replace(/\/+$/,""),includePackageName:i}}return t==="feature"?{base:"components",includePackageName:!0}:t==="block"?{base:"components/blocks",includePackageName:!0}:{base:"components/ui",includePackageName:!0}}function Te(e,o,s){let t=e.startsWith("src/")?e.slice(4):e;if(!o.includePackageName){let u=o.base.split("/").filter(Boolean),l=u[u.length-1];l&&t.startsWith(`${l}/`)&&(t=t.slice(l.length+1))}let a=`${(o.includePackageName?`${o.base}/${s}`:o.base).replace(/\/+/g,"/")}/${t}`.replace(/\/+/g,"/");return{cleanedPath:t,target:a}}async function Re(e){let o=r.join(e,"components.json");try{let s=await m(o,"utf8");return JSON.parse(s).aliases??null}catch{return null}}async function Fe(e){let o=["tsconfig.json","jsconfig.json"].map(s=>r.join(e,s)).find(s=>d(s));if(!o)return null;try{let s=await m(o,"utf8"),i=JSON.parse(s).compilerOptions?.paths;return!i||typeof i!="object"?null:i}catch{return null}}function Be(e,o){if(typeof e=="string"){if(e.trim().startsWith("~/"))return"~/";if(e.trim().startsWith("@/"))return"@/"}if(o){if(Object.prototype.hasOwnProperty.call(o,"~/*"))return"~/";if(Object.prototype.hasOwnProperty.call(o,"@/*"))return"@/"}return"@/"}async function Ue(e,o,s){if(o&&o.length>0)return o;let t=["src/components/ui","app/components/ui","components/ui"];for(let n of t)if(d(r.join(e,n)))return n.replace(/\/ui$/,"");let i=["src/components","app/components","components"];for(let n of i)if(d(r.join(e,n)))return n;if(s){let n=s["@/*"]??s["~/*"]??[];if(Array.isArray(n)&&n.some(a=>/^\.?\/?src\//.test(a)))return"src/components";if(Array.isArray(n)&&n.some(a=>/^\.?\/?app\//.test(a)))return"app/components"}return d(r.join(e,"src"))?"src/components":d(r.join(e,"app"))?"app/components":"components"}async function Le(e,o,s,t){let i=t?.utils??(t?.lib?`${t.lib.replace(/\/+$/,"")}/utils`:void 0);if(i&&i.trim().length>0){let l=T(Pe(i)),g=T(ce(i));for(let p of Q(g))if(d(r.join(e,p)))return{utilsImportPath:l,utilsFilePath:p};return{utilsImportPath:l,utilsFilePath:`${g}.ts`}}let n=De(o),a=n?`${n}/lib/utils`:"lib/utils",u=Array.from(new Set([a,"src/lib/utils","app/lib/utils","lib/utils"]));for(let l of u)for(let g of Q(l))if(d(r.join(e,g)))return{utilsImportPath:`${s}lib/utils`,utilsFilePath:g};return{utilsImportPath:`${s}lib/utils`,utilsFilePath:`${a}.ts`}}function Z(e,o,s){let t=a=>{let u=a.startsWith("/"),l=a.endsWith("/"),g=a.split("/").filter(Boolean),p=[];for(let x of g)p[p.length-1]!==x&&p.push(x);let w=p.join("/");return`${u?"/":""}${w}${l?"/":""}`},i=o.replace(/\/+$/,""),n=e.replace(/^\.?\//,"");if(le.test(n))return t(s);if(n.startsWith("components/")){let a=n.slice(10);return t(`${i}${a}`.replace(/^\//,""))}if(n.startsWith("lib/")){if(i.startsWith("src/"))return t(`src/${n}`);if(i.startsWith("app/"))return t(`app/${n}`)}if(n.startsWith("hooks/")){if(i.startsWith("src/"))return t(`src/${n}`);if(i.startsWith("app/"))return t(`app/${n}`)}return n.startsWith("ui/")?t(`${i}/${n}`):t(n)}function U(e,o){let s=o.startsWith("~/")?"~/":"@/",t=e;return t=t.replace(/@\/registry\/default\/components\//g,`${s}components/`),t=t.replace(/@\/registry\/default\/ui\//g,`${s}components/ui/`),t=t.replace(/@\/registry\/default\/hooks\//g,`${s}hooks/`),t=t.replace(/@\/registry\/default\/lib\//g,`${s}lib/`),t=t.replace(/@loveui\/ui\/ui\//g,`${s}components/ui/`),t=t.replace(/@loveui\/ui\/lib\//g,`${s}lib/`),t=t.replace(/@\/ui\//g,`${s}components/ui/`),t=t.replace(/@\/registry\/building-blocks\/default\/components\//g,`${s}components/`),t=t.replace(/@\/registry\/building-blocks\/default\/ui\//g,`${s}components/ui/`),t=t.replace(/@\/registry\/building-blocks\/default\/lib\//g,`${s}lib/`),t=t.replace(/@\/registry\/building-blocks\/default\/hooks\//g,`${s}hooks/`),t=t.replace(/@\/registry\/default\/components\//g,`${s}components/`),t=t.replace(/@\/registry\/default\/ui\//g,`${s}components/ui/`),t=t.replace(/@\/registry\/default\/lib\//g,`${s}lib/`),t=t.replace(/@\/registry\/default\/hooks\//g,`${s}hooks/`),t=t.replace(/from\s+["']@loveui\/ui\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["']@loveui\/shadcn-ui\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["']@love-ui\/shadcn-ui\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["']@\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["']~\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["'](?:\.\.\/)+ui\/src\/lib\/utils["']/g,`from "${o}"`),t}async function Ce(e,o){if(d(r.join(e,o)))return!1;let s=$e,t=r.join(G,"love-ui","src","lib","utils.ts");if(d(t))try{s=await m(t,"utf8")}catch{}return await z(o,e),await R(r.join(e,o),s,"utf8"),!0}async function Ee(e){let s=["app/globals.css","app/global.css","src/app/globals.css","src/app/global.css","styles/globals.css","src/styles/globals.css","globals.css","global.css"].find(l=>d(r.join(e,l)));s||(d(r.join(e,"src","app"))?s="src/app/globals.css":d(r.join(e,"app"))?s="app/globals.css":d(r.join(e,"src"))?s="src/styles/globals.css":s="globals.css");let t=r.join(e,s),i=d(t),n=i?await m(t,"utf8"):"",a=!1;/@import\s+["']tailwindcss["']/.test(n)||(n=`@import "tailwindcss";
${n?`
...
${n}`;return await R(i,u,"utf8"),!0}function Ae(e,o){let s=r.posix.relative(e||".",o);return s.startsWith(".")||(s=`./${s}`),s}async function z(e,o){let s=r.dirname(r.join(o,e));await F(s,{recursive:!0})}async function Oe(e,o){let s=r.join(e,"package.json"),t={};try{let l=await m(s,"utf8");t=JSON.parse(l)}catch{}let i=Se(t),n=L(o),a=[];async function u(l,g){let p=await se(l,{withFileTypes:!0});for(let w of p){if(X.has(w.name))continue;let x=r.join(l,w.name);if(w.isDirectory()){await u(x,g);continue}let D=r.extname(w.name);if(!re.has(D)||w.name==="package.json")continue;let P=r.relative(g,x).split(r.sep).join("/"),{target:j}=Te(P,i,n),y=await m(x,"utf8");a.push({path:P,target:j,content:y})}}return await u(e,e),a}async function _e(e,o){let s=ae.get(e);if(!s)return null;let t=r.join(B,"default","blocks",s.sourceDir);if(!d(t))return null;try{let i=[],n=[],a=new Set;async function u(l){let g=await se(l,{withFileTypes:!0});for(let p of g){if(X.has(p.name))continue;let w=r.join(l,p.name);if(p.isDirectory()){await u(w);continue}let x=r.extname(p.name);if(!re.has(x))continue;let D=r.relative(t,w).split(r.sep).join("/"),P=await m(w,"utf8");for(let j of P.matchAll(/@\/registry\/default\/ui\/([^"']+)/g)){let y=j[1];y&&a.add(y)}n.push({path:`default/blocks/${s.sourceDir}/${D}`,target:`${s.targetBase}/${D}`,content:P})}}await u(t);for(let l of Array.from(a).sort((g,p)=>g.localeCompare(p))){let g=await J(l,o);g&&i.push(...g)}return i.push(...n),i}catch(i){return console.warn(`Warning: unable to read ${e} from bundled blocks`,i),null}}async function J(e,o){let s=r.join(B,"default","ui",`${e}.tsx`);if(d(s))try{let n=U(await m(s,"utf8"),o),a=[{path:`default/ui/${e}.tsx`,target:`components/ui/${e}.tsx`,content:n}];if(e==="toast"){let u=["toast-gooey.tsx","toast-gooey-renderer.tsx","toast-gooey-icons.tsx","toast-gooey-types.ts","toast-gooey.css"];for(let l of u){let g=r.join(B,"default","ui",l);d(g)&&a.push({path:`default/ui/${l}`,target:`components/ui/${l}`,content:await m(g,"utf8")})}}return a}catch(n){console.warn(`Warning: unable to read ${e} from bundled registry`,n)}let t=r.join(G,"love-ui"),i=r.join(t,"src","ui",`${e}.tsx`);if(!d(i))return null;try{let n=[],a=await m(i,"utf8");a=U(a,o),n.push({path:`src/ui/${e}.tsx`,target:`components/ui/${e}.tsx`,content:a});let u=r.join(t,"src","lib","utils.ts");if(d(u)){let l=await m(u,"utf8");n.push({path:"src/lib/utils.ts",target:"lib/utils.ts",content:l})}return n}catch(n){return console.warn(`Warning: unable to read ${e} component`,n),null}}async function We(e,o){if(ie.has(e))return await J(e,o);let s=r.join(B,"default","examples",`${e}.tsx`);if(d(s))try{let a=await m(s,"utf8"),u=[],l=Array.from(new Set([...a.matchAll(/@\/registry\/default\/ui\/([^"']+)/g)].map(g=>g[1]).filter(Boolean)));for(let g of l){let p=await J(g,o);p&&u.push(...p)}return u.push({path:`default/examples/${e}.tsx`,target:`components/${e}.tsx`,content:U(a,o)}),u}catch(a){return console.warn(`Warning: unable to read ${e} from bundled registry examples`,a),null}let t=await _e(e,o);if(t)return t;let i=ue(e),n=r.join(G,i);if(!d(n))return null;try{return await Oe(n,e)}catch(a){return console.warn(`Warning: unable to read bundled sources for ${e}`,a),null}}async function de(e){let o=r.join(ke,L(e));return!d(o)||!d(r.join(o,"SKILL.md"))?null:o}var M=["codex","claude","cursor","github"],ee=new Set(M);function Me(){let e=process.env.CODEX_HOME?.trim();return e||r.join(ne.homedir(),".codex")}function ze(){let e=process.env.CLAUDE_HOME?.trim();return e||r.join(ne.homedir(),".claude")}async function _(e,o){let s=await de(e);if(!s)throw new Error(`Bundled skill "${e}" was not found in this love-ui package.`);return await F(r.dirname(o),{recursive:!0}),d(o)?"exists":(await pe(s,o,{recursive:!0,force:!1,filter:t=>{let i=r.basename(t);return!X.has(i)}}),"installed")}async function te(e,o){return await F(r.dirname(e),{recursive:!0}),d(e)?"exists":(await R(e,o,"utf8"),"installed")}function Ge(e){return`---
