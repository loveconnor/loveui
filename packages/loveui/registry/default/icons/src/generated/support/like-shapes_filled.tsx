...
export interface LikeShapesFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LikeShapesFilled = React.forwardRef<SVGSVGElement, LikeShapesFilledProps>(
...
export default LikeShapesFilled;
