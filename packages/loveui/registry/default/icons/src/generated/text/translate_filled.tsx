...
export interface TranslateFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TranslateFilled = React.forwardRef<SVGSVGElement, TranslateFilledProps>(
...
<path d="M16.3799 17.1601H17.4699L16.9199 16.0701L16.3799 17.1601Z" fill="currentColor"/>
    </svg>
  )
);
TranslateFilled.displayName = "TranslateFilled";
export const TranslateFilledMetadata = { 
  id: "translate_filled", 
  baseId: "translate", 
  variant: "filled", 
  name: "Translate", 
