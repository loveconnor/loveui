...
export interface MusicSquareSearchFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MusicSquareSearchFilled = React.forwardRef<SVGSVGElement, MusicSquareSearchFilledProps>(
...
MusicSquareSearchFilled.displayName = "MusicSquareSearchFilled";
export const MusicSquareSearchFilledMetadata = { 
  id: "music-square-search_filled", 
...
export default MusicSquareSearchFilled;
