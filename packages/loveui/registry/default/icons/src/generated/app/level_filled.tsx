...
export interface LevelFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LevelFilled = React.forwardRef<SVGSVGElement, LevelFilledProps>(
...
LevelFilled.displayName = "LevelFilled";
export const LevelFilledMetadata = { 
  id: "level_filled", 
  baseId: "level", 
  variant: "filled", 
  name: "Level", 
