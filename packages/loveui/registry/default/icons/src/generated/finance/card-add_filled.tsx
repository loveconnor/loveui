...
export interface CardAddFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CardAddFilled = React.forwardRef<SVGSVGElement, CardAddFilledProps>(
...
CardAddFilled.displayName = "CardAddFilled";
export const CardAddFilledMetadata = { 
  id: "card-add_filled", 
  baseId: "card-add", 
  variant: "filled", 
  name: "Card Add", 
