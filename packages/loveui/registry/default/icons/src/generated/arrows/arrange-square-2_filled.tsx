...
export interface ArrangeSquare2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrangeSquare2Filled = React.forwardRef<SVGSVGElement, ArrangeSquare2FilledProps>(
...
ArrangeSquare2Filled.displayName = "ArrangeSquare2Filled";
export const ArrangeSquare2FilledMetadata = { 
  id: "arrange-square-2_filled", 
...
export default ArrangeSquare2Filled;
