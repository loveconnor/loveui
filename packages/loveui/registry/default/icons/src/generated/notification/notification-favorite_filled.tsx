...
export interface NotificationFavoriteFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const NotificationFavoriteFilled = React.forwardRef<SVGSVGElement, NotificationFavoriteFilledProps>(
...
NotificationFavoriteFilled.displayName = "NotificationFavoriteFilled";
export const NotificationFavoriteFilledMetadata = { 
  id: "notification-favorite_filled", 
...
export default NotificationFavoriteFilled;
