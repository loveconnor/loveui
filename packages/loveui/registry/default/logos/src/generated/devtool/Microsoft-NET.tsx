...
export interface MicrosoftNETProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MicrosoftNET = React.forwardRef<SVGSVGElement, MicrosoftNETProps>(
...
export const MicrosoftNETMetadata = {
  id: "Microsoft-NET",
  baseId: "Microsoft-NET",
  variant: "default",
  name: "Microsoft NET",
  category: "devtool",
  tags: [],
