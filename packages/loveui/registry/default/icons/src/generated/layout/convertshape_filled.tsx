...
export interface ConvertshapeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ConvertshapeFilled = React.forwardRef<SVGSVGElement, ConvertshapeFilledProps>(
...
ConvertshapeFilled.displayName = "ConvertshapeFilled";
export const ConvertshapeFilledMetadata = { 
  id: "convertshape_filled", 
  baseId: "convertshape", 
  variant: "filled", 
  name: "Convertshape", 
  category: "layout", 
...
export default ConvertshapeFilled;
