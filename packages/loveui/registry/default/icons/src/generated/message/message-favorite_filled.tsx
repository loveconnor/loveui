...
export interface MessageFavoriteFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MessageFavoriteFilled = React.forwardRef<SVGSVGElement, MessageFavoriteFilledProps>(
...
MessageFavoriteFilled.displayName = "MessageFavoriteFilled";
export const MessageFavoriteFilledMetadata = { 
  id: "message-favorite_filled", 
...
export default MessageFavoriteFilled;
