...
export interface DriverFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DriverFilled = React.forwardRef<SVGSVGElement, DriverFilledProps>(
...
DriverFilled.displayName = "DriverFilled";
export const DriverFilledMetadata = { 
  id: "driver_filled", 
  baseId: "driver", 
  variant: "filled", 
  name: "Driver", 
