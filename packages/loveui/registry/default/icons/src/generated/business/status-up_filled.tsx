...
export interface StatusUpFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const StatusUpFilled = React.forwardRef<SVGSVGElement, StatusUpFilledProps>(
...
StatusUpFilled.displayName = "StatusUpFilled";
export const StatusUpFilledMetadata = { 
  id: "status-up_filled", 
  baseId: "status-up", 
  variant: "filled", 
  name: "Status Up", 
