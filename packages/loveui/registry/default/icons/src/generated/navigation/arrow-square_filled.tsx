...
export interface ArrowSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowSquareFilled = React.forwardRef<SVGSVGElement, ArrowSquareFilledProps>(
...
ArrowSquareFilled.displayName = "ArrowSquareFilled";
export const ArrowSquareFilledMetadata = { 
  id: "arrow-square_filled", 
  baseId: "arrow-square", 
  variant: "filled", 
  name: "Arrow Square", 
  category: "navigation", 
...
export default ArrowSquareFilled;
