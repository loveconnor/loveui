...
export interface ChartSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChartSquareFilled = React.forwardRef<SVGSVGElement, ChartSquareFilledProps>(
...
ChartSquareFilled.displayName = "ChartSquareFilled";
export const ChartSquareFilledMetadata = { 
  id: "chart-square_filled", 
  baseId: "chart-square", 
  variant: "filled", 
  name: "Chart Square", 
  category: "finance", 
...
export default ChartSquareFilled;
