...
export interface ShopFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ShopFilled = React.forwardRef<SVGSVGElement, ShopFilledProps>(
