...
export interface SortFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SortFilled = React.forwardRef<SVGSVGElement, SortFilledProps>(
...
export const SortFilledMetadata = { 
  id: "sort_filled", 
  baseId: "sort", 
  variant: "filled", 
  name: "Sort", 
