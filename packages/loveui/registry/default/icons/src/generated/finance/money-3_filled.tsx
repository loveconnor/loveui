...
export interface Money3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Money3Filled = React.forwardRef<SVGSVGElement, Money3FilledProps>(
...
Money3Filled.displayName = "Money3Filled";
export const Money3FilledMetadata = { 
  id: "money-3_filled", 
  baseId: "money-3", 
  variant: "filled", 
  name: "Money 3", 
