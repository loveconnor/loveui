...
export interface NoteAddFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const NoteAddFilled = React.forwardRef<SVGSVGElement, NoteAddFilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M8.29001 6.29C7.87001 6.29 7.54001 5.95 7.54001 5.54V2.75C7.54001 2.34 7.87001 2 8.29001 2C8.71001 2 9.04001 2.34 9.04001 2.75V5.53C9.04001 5.95 8.71001 6.29 8.29001 6.29Z" fill="currentColor"/>
...
NoteAddFilled.displayName = "NoteAddFilled";
export const NoteAddFilledMetadata = { 
  id: "note-add_filled", 
  baseId: "note-add", 
  variant: "filled", 
  name: "Note Add", 
