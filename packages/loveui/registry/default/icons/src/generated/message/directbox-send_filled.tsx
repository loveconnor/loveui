...
export interface DirectboxSendFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DirectboxSendFilled = React.forwardRef<SVGSVGElement, DirectboxSendFilledProps>(
...
export default DirectboxSendFilled;
