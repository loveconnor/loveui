...
export interface RotateLeftFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RotateLeftFilled = React.forwardRef<SVGSVGElement, RotateLeftFilledProps>(
...
export const RotateLeftFilledMetadata = { 
  id: "rotate-left_filled", 
  baseId: "rotate-left", 
  variant: "filled", 
  name: "Rotate Left", 
  category: "arrows", 
