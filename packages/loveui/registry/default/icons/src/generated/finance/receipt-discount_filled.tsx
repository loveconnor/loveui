...
export interface ReceiptDiscountFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptDiscountFilled = React.forwardRef<SVGSVGElement, ReceiptDiscountFilledProps>(
...
ReceiptDiscountFilled.displayName = "ReceiptDiscountFilled";
export const ReceiptDiscountFilledMetadata = { 
  id: "receipt-discount_filled", 
...
export default ReceiptDiscountFilled;
