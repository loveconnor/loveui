...
export interface Maximize1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Maximize1Filled = React.forwardRef<SVGSVGElement, Maximize1FilledProps>(
...
Maximize1Filled.displayName = "Maximize1Filled";
export const Maximize1FilledMetadata = { 
  id: "maximize-1_filled", 
  baseId: "maximize-1", 
  variant: "filled", 
  name: "Maximize 1", 
  category: "layout", 
...
export default Maximize1Filled;
