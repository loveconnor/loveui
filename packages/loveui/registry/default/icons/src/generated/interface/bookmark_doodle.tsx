...
export interface BookmarkDoodleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BookmarkDoodle = React.forwardRef<SVGSVGElement, BookmarkDoodleProps>(
