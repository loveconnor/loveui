...
export interface GalleryTickFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GalleryTickFilled = React.forwardRef<SVGSVGElement, GalleryTickFilledProps>(
...
GalleryTickFilled.displayName = "GalleryTickFilled";
export const GalleryTickFilledMetadata = { 
  id: "gallery-tick_filled", 
  baseId: "gallery-tick", 
  variant: "filled", 
  name: "Gallery Tick", 
  category: "multimedia", 
...
export default GalleryTickFilled;
