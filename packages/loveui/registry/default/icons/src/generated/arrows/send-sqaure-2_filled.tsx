...
export interface SendSqaure2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SendSqaure2Filled = React.forwardRef<SVGSVGElement, SendSqaure2FilledProps>(
...
SendSqaure2Filled.displayName = "SendSqaure2Filled";
export const SendSqaure2FilledMetadata = { 
  id: "send-sqaure-2_filled", 
...
export default SendSqaure2Filled;
