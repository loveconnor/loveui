...
export interface Sun1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Sun1Filled = React.forwardRef<SVGSVGElement, Sun1FilledProps>(
...
Sun1Filled.displayName = "Sun1Filled";
export const Sun1FilledMetadata = { 
  id: "sun-1_filled", 
  baseId: "sun-1", 
  variant: "filled", 
  name: "Sun 1", 
