...
export interface DangerFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DangerFilled = React.forwardRef<SVGSVGElement, DangerFilledProps>(
...
export const DangerFilledMetadata = { 
  id: "danger_filled", 
  baseId: "danger", 
  variant: "filled", 
  name: "Danger", 
