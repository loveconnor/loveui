...
const CODE_BASE = `${LOVEUI_URL}/code/apps/v4/registry/bases`
...
export async function collectInfo(
  ...
  return {
    ...
    components,
    links: {
      docs: `${LOVEUI_URL}/docs`,
      components: `${LOVEUI_URL}/docs/components/${base}/[component].md`,
      ui: `${CODE_BASE}/${base}/ui/[component].tsx`,
      examples: `${CODE_BASE}/${base}/examples/[component]-example.tsx`,
      schema: `${LOVEUI_URL}/schema.json`,
    },
  }
}
...
export function printPresetInfo(
  ...
  if (!preset?.code) {
    ...
    printEntries({
      ...
      url: `${LOVEUI_URL}/create?preset=${preset.code}`,
    })
