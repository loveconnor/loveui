...
export interface AttachCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AttachCircleFilled = React.forwardRef<SVGSVGElement, AttachCircleFilledProps>(
...
AttachCircleFilled.displayName = "AttachCircleFilled";
export const AttachCircleFilledMetadata = { 
  id: "attach-circle_filled", 
...
export default AttachCircleFilled;
