...
export interface PersonalcardFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PersonalcardFilled = React.forwardRef<SVGSVGElement, PersonalcardFilledProps>(
...
PersonalcardFilled.displayName = "PersonalcardFilled";
export const PersonalcardFilledMetadata = { 
  id: "personalcard_filled", 
  baseId: "personalcard", 
  variant: "filled", 
  name: "Personalcard", 
  category: "business", 
...
export default PersonalcardFilled;
