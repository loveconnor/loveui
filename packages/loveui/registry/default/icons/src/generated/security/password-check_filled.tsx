...
export interface PasswordCheckFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PasswordCheckFilled = React.forwardRef<SVGSVGElement, PasswordCheckFilledProps>(
...
PasswordCheckFilled.displayName = "PasswordCheckFilled";
export const PasswordCheckFilledMetadata = { 
  id: "password-check_filled", 
...
export default PasswordCheckFilled;
