...
export interface SmsNotificationFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SmsNotificationFilled = React.forwardRef<SVGSVGElement, SmsNotificationFilledProps>(
...
SmsNotificationFilled.displayName = "SmsNotificationFilled";
export const SmsNotificationFilledMetadata = { 
  id: "sms-notification_filled", 
...
export default SmsNotificationFilled;
