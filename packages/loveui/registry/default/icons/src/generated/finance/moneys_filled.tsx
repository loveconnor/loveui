...
export interface MoneysFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MoneysFilled = React.forwardRef<SVGSVGElement, MoneysFilledProps>(
