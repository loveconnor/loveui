...
export interface DocumentFilterFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DocumentFilterFilled = React.forwardRef<SVGSVGElement, DocumentFilterFilledProps>(
...
DocumentFilterFilled.displayName = "DocumentFilterFilled";
export const DocumentFilterFilledMetadata = { 
  id: "document-filter_filled", 
...
export default DocumentFilterFilled;
