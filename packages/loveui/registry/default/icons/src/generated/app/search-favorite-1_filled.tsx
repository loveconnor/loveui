...
export interface SearchFavorite1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SearchFavorite1Filled = React.forwardRef<SVGSVGElement, SearchFavorite1FilledProps>(
...
SearchFavorite1Filled.displayName = "SearchFavorite1Filled";
export const SearchFavorite1FilledMetadata = { 
  id: "search-favorite-1_filled", 
