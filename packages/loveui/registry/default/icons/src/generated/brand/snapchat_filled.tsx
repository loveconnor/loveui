...
export interface SnapchatFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SnapchatFilled = React.forwardRef<SVGSVGElement, SnapchatFilledProps>(
...
SnapchatFilled.displayName = "SnapchatFilled";
export const SnapchatFilledMetadata = { 
  id: "snapchat_filled", 
  baseId: "snapchat", 
  variant: "filled", 
  name: "Snapchat", 
