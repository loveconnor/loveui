...
export interface ReceiveSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiveSquareFilled = React.forwardRef<SVGSVGElement, ReceiveSquareFilledProps>(
...
ReceiveSquareFilled.displayName = "ReceiveSquareFilled";
export const ReceiveSquareFilledMetadata = { 
  id: "receive-square_filled", 
...
export default ReceiveSquareFilled;
