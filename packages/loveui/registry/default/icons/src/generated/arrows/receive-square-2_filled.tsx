...
export interface ReceiveSquare2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiveSquare2Filled = React.forwardRef<SVGSVGElement, ReceiveSquare2FilledProps>(
...
ReceiveSquare2Filled.displayName = "ReceiveSquare2Filled";
export const ReceiveSquare2FilledMetadata = { 
  id: "receive-square-2_filled", 
...
export default ReceiveSquare2Filled;
