...
export interface TrendUpFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TrendUpFilled = React.forwardRef<SVGSVGElement, TrendUpFilledProps>(
...
TrendUpFilled.displayName = "TrendUpFilled";
export const TrendUpFilledMetadata = { 
  id: "trend-up_filled", 
  baseId: "trend-up", 
  variant: "filled", 
  name: "Trend Up", 
