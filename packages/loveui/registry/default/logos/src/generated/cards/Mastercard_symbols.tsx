...
export interface MastercardSymbolsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MastercardSymbols = React.forwardRef<SVGSVGElement, MastercardSymbolsProps>(
...
MastercardSymbols.displayName = "MastercardSymbols";

export const MastercardSymbolsMetadata = {
  id: "Mastercard_symbols",
  baseId: "Mastercard",
  variant: "symbols",
  name: "Mastercard",
  category: "cards",
...
export default MastercardSymbols;
