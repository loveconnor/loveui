...
export interface RepeatCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RepeatCircleFilled = React.forwardRef<SVGSVGElement, RepeatCircleFilledProps>(
...
RepeatCircleFilled.displayName = "RepeatCircleFilled";
export const RepeatCircleFilledMetadata = { 
  id: "repeat-circle_filled", 
