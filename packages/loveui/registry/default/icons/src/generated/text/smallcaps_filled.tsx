...
export interface SmallcapsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SmallcapsFilled = React.forwardRef<SVGSVGElement, SmallcapsFilledProps>(
...
SmallcapsFilled.displayName = "SmallcapsFilled";
export const SmallcapsFilledMetadata = { 
  id: "smallcaps_filled", 
  baseId: "smallcaps", 
  variant: "filled", 
  name: "Smallcaps", 
...
export default SmallcapsFilled;
