...
export interface ArrowSingleDownDoodleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowSingleDownDoodle = React.forwardRef<SVGSVGElement, ArrowSingleDownDoodleProps>(
...
export default ArrowSingleDownDoodle;
