...
export interface DocumentCodeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DocumentCodeFilled = React.forwardRef<SVGSVGElement, DocumentCodeFilledProps>(
...
DocumentCodeFilled.displayName = "DocumentCodeFilled";
export const DocumentCodeFilledMetadata = { 
  id: "document-code_filled", 
