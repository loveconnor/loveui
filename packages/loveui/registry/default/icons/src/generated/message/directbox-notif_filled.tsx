...
export interface DirectboxNotifFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DirectboxNotifFilled = React.forwardRef<SVGSVGElement, DirectboxNotifFilledProps>(
...
export default DirectboxNotifFilled;
