...
export interface DecredDcrFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DecredDcrFilled = React.forwardRef<SVGSVGElement, DecredDcrFilledProps>(
...
DecredDcrFilled.displayName = "DecredDcrFilled";
export const DecredDcrFilledMetadata = { 
  id: "decred-dcr_filled", 
  baseId: "decred-dcr", 
  variant: "filled", 
  name: "Decred Dcr", 
  category: "brand", 
...
export default DecredDcrFilled;
