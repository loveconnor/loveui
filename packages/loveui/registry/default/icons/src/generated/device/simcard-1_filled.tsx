...
export interface Simcard1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Simcard1Filled = React.forwardRef<SVGSVGElement, Simcard1FilledProps>(
...
Simcard1Filled.displayName = "Simcard1Filled";
export const Simcard1FilledMetadata = { 
  id: "simcard-1_filled", 
  baseId: "simcard-1", 
  variant: "filled", 
  name: "Simcard 1", 
