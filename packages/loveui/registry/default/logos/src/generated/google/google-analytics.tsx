...
export interface GoogleAnalyticsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const GoogleAnalytics = React.forwardRef<SVGSVGElement, GoogleAnalyticsProps>(
...
export const GoogleAnalyticsMetadata = {
  id: "google-analytics",
  baseId: "google-analytics",
  variant: "default",
