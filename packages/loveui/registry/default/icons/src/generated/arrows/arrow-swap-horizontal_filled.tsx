...
export interface ArrowSwapHorizontalFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowSwapHorizontalFilled = React.forwardRef<SVGSVGElement, ArrowSwapHorizontalFilledProps>(
...
ArrowSwapHorizontalFilled.displayName = "ArrowSwapHorizontalFilled";
export const ArrowSwapHorizontalFilledMetadata = { 
  id: "arrow-swap-horizontal_filled", 
...
export default ArrowSwapHorizontalFilled;
