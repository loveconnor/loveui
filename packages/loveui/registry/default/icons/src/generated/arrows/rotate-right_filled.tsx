...
export interface RotateRightFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RotateRightFilled = React.forwardRef<SVGSVGElement, RotateRightFilledProps>(
...
export const RotateRightFilledMetadata = { 
  id: "rotate-right_filled", 
  baseId: "rotate-right", 
  variant: "filled", 
  name: "Rotate Right", 
  category: "arrows", 
