...
export interface HashtagUpFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HashtagUpFilled = React.forwardRef<SVGSVGElement, HashtagUpFilledProps>(
...
HashtagUpFilled.displayName = "HashtagUpFilled";
export const HashtagUpFilledMetadata = { 
  id: "hashtag-up_filled", 
  baseId: "hashtag-up", 
  variant: "filled", 
  name: "Hashtag Up", 
  category: "code", 
...
export default HashtagUpFilled;
