...
export interface RwandaSymbolsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const RwandaSymbols = React.forwardRef<SVGSVGElement, RwandaSymbolsProps>(
...
RwandaSymbols.displayName = "RwandaSymbols";

export const RwandaSymbolsMetadata = {
  id: "Rwanda_symbols",
  baseId: "Rwanda",
  variant: "symbols",
  name: "Rwanda",
