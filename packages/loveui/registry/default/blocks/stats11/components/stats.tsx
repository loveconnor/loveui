    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Set a monthly guardrail for LoveUI registry previews, test installs, and generated
            screenshots. Your team can keep building without surprise usage spikes.
          </DialogDescription>
        </DialogHeader>
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4">
        ...
        <MetricCard
          title="Preview bandwidth"
          value="141 GB"
          limit="150 GB"
          percentage={94}
          progressColor="bg-orange-500"
          warningMessage="Preview traffic is close to the monthly guardrail."
          actionLabel="Upgrade"
          actionIcon={<Box className="h-4 w-4" />}
        />
