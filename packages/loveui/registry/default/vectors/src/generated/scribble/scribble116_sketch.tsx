...
export interface Scribble116SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble116Sketch = React.forwardRef<SVGSVGElement, Scribble116SketchProps>(
...
export default Scribble116Sketch;
