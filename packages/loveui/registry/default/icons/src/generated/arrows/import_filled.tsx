...
export interface ImportFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ImportFilled = React.forwardRef<SVGSVGElement, ImportFilledProps>(
...
export const ImportFilledMetadata = { 
  id: "import_filled", 
  baseId: "import", 
  variant: "filled", 
  name: "Import", 
