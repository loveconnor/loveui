...
export interface UserTagFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const UserTagFilled = React.forwardRef<SVGSVGElement, UserTagFilledProps>(
...
UserTagFilled.displayName = "UserTagFilled";
export const UserTagFilledMetadata = { 
  id: "user-tag_filled", 
  baseId: "user-tag", 
  variant: "filled", 
  name: "User Tag", 
