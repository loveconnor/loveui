...
export interface UndoFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const UndoFilled = React.forwardRef<SVGSVGElement, UndoFilledProps>(
...
UndoFilled.displayName = "UndoFilled";
export const UndoFilledMetadata = { 
  id: "undo_filled", 
  baseId: "undo", 
  variant: "filled", 
  name: "Undo", 
