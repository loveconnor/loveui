...
export interface TrendDownFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TrendDownFilled = React.forwardRef<SVGSVGElement, TrendDownFilledProps>(
...
export const TrendDownFilledMetadata = { 
  id: "trend-down_filled", 
  baseId: "trend-down", 
  variant: "filled", 
  name: "Trend Down", 
  category: "business", 
...
export default TrendDownFilled;
