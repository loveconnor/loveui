...
export interface AirplaneSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AirplaneSquareFilled = React.forwardRef<SVGSVGElement, AirplaneSquareFilledProps>(
...
AirplaneSquareFilled.displayName = "AirplaneSquareFilled";
export const AirplaneSquareFilledMetadata = { 
  id: "airplane-square_filled", 
...
export default AirplaneSquareFilled;
