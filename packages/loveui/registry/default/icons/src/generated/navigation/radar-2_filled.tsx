...
export interface Radar2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Radar2Filled = React.forwardRef<SVGSVGElement, Radar2FilledProps>(
...
Radar2Filled.displayName = "Radar2Filled";
export const Radar2FilledMetadata = { 
  id: "radar-2_filled", 
  baseId: "radar-2", 
  variant: "filled", 
  name: "Radar 2", 
