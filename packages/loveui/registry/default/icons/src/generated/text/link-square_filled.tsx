...
export interface LinkSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LinkSquareFilled = React.forwardRef<SVGSVGElement, LinkSquareFilledProps>(
...
LinkSquareFilled.displayName = "LinkSquareFilled";
export const LinkSquareFilledMetadata = { 
  id: "link-square_filled", 
  baseId: "link-square", 
  variant: "filled", 
  name: "Link Square", 
  category: "text", 
