...
export interface LikeDislikeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LikeDislikeFilled = React.forwardRef<SVGSVGElement, LikeDislikeFilledProps>(
...
export default LikeDislikeFilled;
