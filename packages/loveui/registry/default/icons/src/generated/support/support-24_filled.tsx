...
export interface Support24FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Support24Filled = React.forwardRef<SVGSVGElement, Support24FilledProps>(
...
<path d="M15.29 11.5801V8.64014C14.7 9.60014 14.09 10.6301 13.54 11.5701H15.29V11.5801Z" fill="currentColor"/>
    </svg>
  )
);
Support24Filled.displayName = "Support24Filled";
export const Support24FilledMetadata = { 
  id: "support-24_filled", 
  baseId: "support-24", 
  variant: "filled", 
  name: "Support 24", 
  category: "support", 
...
export default Support24Filled;
