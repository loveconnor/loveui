...
export interface Setting3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Setting3Filled = React.forwardRef<SVGSVGElement, Setting3FilledProps>(
...
Setting3Filled.displayName = "Setting3Filled";
export const Setting3FilledMetadata = { 
  id: "setting-3_filled", 
  baseId: "setting-3", 
  variant: "filled", 
  name: "Setting 3", 
