...
export interface SendSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SendSquareFilled = React.forwardRef<SVGSVGElement, SendSquareFilledProps>(
...
SendSquareFilled.displayName = "SendSquareFilled";
export const SendSquareFilledMetadata = { 
  id: "send-square_filled", 
  baseId: "send-square", 
  variant: "filled", 
  name: "Send Square", 
  category: "arrows", 
...
export default SendSquareFilled;
