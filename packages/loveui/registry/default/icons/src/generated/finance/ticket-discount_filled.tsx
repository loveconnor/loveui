...
export interface TicketDiscountFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TicketDiscountFilled = React.forwardRef<SVGSVGElement, TicketDiscountFilledProps>(
...
export default TicketDiscountFilled;
