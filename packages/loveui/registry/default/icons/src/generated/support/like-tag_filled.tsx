...
export interface LikeTagFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LikeTagFilled = React.forwardRef<SVGSVGElement, LikeTagFilledProps>(
...
LikeTagFilled.displayName = "LikeTagFilled";
export const LikeTagFilledMetadata = { 
  id: "like-tag_filled", 
  baseId: "like-tag", 
  variant: "filled", 
  name: "Like Tag", 
