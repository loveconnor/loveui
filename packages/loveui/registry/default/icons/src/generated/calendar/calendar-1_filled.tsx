...
export interface Calendar1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Calendar1Filled = React.forwardRef<SVGSVGElement, Calendar1FilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M8.25 5.75C7.84 5.75 7.5 5.41 7.5 5V2C7.5 1.59 7.84 1.25 8.25 1.25C8.66 1.25 9 1.59 9 2V5C9 5.41 8.66 5.75 8.25 5.75Z" fill="currentColor"/>
<path d="M15.75 5.75C15.34 5.75 15 5.41 15 5V2C15 1.59 15.34 1.25 15.75 1.25C16.16 1.25 16.5 1.59 16.5 2V5C16.5 5.41 16.16 5.75 15.75 5.75Z" fill="currentColor"/>
<path d="M12 14.09C12.52 14.09 12.9 13.78 12.9 13.29C12.9 12.79 12.52 12.5 12 12.5C11.48 12.5 11.1 12.79 11.1 13.29C11.1 13.78 11.48 14.09 12 14.09Z" fill="currentColor"/>
<path d="M12 17.0001C12.6296 17.0001 13.14 16.5838 13.14 16.0701C13.14 15.5565 12.6296 15.1401 12 15.1401C11.3704 15.1401 10.86 15.5565 10.86 16.0701C10.86 16.5838 11.3704 17.0001 12 17.0001Z" fill="currentColor"/>
...
Calendar1Filled.displayName = "Calendar1Filled";
export const Calendar1FilledMetadata = { 
  id: "calendar-1_filled", 
  baseId: "calendar-1", 
  variant: "filled", 
  name: "Calendar 1", 
  category: "calendar", 
