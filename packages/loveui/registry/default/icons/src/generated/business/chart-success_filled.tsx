...
export interface ChartSuccessFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChartSuccessFilled = React.forwardRef<SVGSVGElement, ChartSuccessFilledProps>(
...
ChartSuccessFilled.displayName = "ChartSuccessFilled";
export const ChartSuccessFilledMetadata = { 
  id: "chart-success_filled", 
...
export default ChartSuccessFilled;
