...
export interface MessageText1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MessageText1Filled = React.forwardRef<SVGSVGElement, MessageText1FilledProps>(
...
MessageText1Filled.displayName = "MessageText1Filled";
export const MessageText1FilledMetadata = { 
  id: "message-text-1_filled", 
...
export default MessageText1Filled;
