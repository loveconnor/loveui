...
export interface BagFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BagFilled = React.forwardRef<SVGSVGElement, BagFilledProps>(
