...
export interface CallCallingFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CallCallingFilled = React.forwardRef<SVGSVGElement, CallCallingFilledProps>(
...
<path d="M21.23 10.75C20.8 10.75 20.46 10.4 20.46 9.98C20.46 6.43 17.57 3.55 14.03 3.55C13.6 3.55 13.26 3.2 13.26 2.78C13.26 2.36 13.6 2 14.02 2C18.42 2 22 5.58 22 9.98C22 10.4 21.65 10.75 21.23 10.75Z" fill="currentColor"/>
...
CallCallingFilled.displayName = "CallCallingFilled";
export const CallCallingFilledMetadata = { 
  id: "call-calling_filled", 
  baseId: "call-calling", 
  variant: "filled", 
  name: "Call Calling", 
...
export default CallCallingFilled;
