...
export interface Import2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Import2Filled = React.forwardRef<SVGSVGElement, Import2FilledProps>(
...
Import2Filled.displayName = "Import2Filled";
export const Import2FilledMetadata = { 
  id: "import-2_filled", 
  baseId: "import-2", 
  variant: "filled", 
  name: "Import 2", 
