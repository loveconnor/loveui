...
export interface MusicSquareRemoveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MusicSquareRemoveFilled = React.forwardRef<SVGSVGElement, MusicSquareRemoveFilledProps>(
...
<path d="M12.23 12.0701C11.82 12.0701 11.49 12.4001 11.49 12.8101C11.49 13.2201 11.82 13.5501 12.23 13.5501C12.64 13.5501 12.97 13.2201 12.97 12.8101C12.97 12.4001 12.64 12.0701 12.23 12.0701Z" fill="currentColor"/>
<path d="M6.76002 13.0601C6.35002 13.0601 6.02002 13.3901 6.02002 13.8001C6.02002 14.2101 6.35002 14.5401 6.76002 14.5401C7.17002 14.5401 7.50002 14.2101 7.50002 13.8001C7.50002 13.3901 7.17002 13.0601 6.76002 13.0601Z" fill="currentColor"/>
...
MusicSquareRemoveFilled.displayName = "MusicSquareRemoveFilled";
export const MusicSquareRemoveFilledMetadata = { 
  id: "music-square-remove_filled", 
...
export default MusicSquareRemoveFilled;
