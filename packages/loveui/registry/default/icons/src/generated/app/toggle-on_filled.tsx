...
export interface ToggleOnFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ToggleOnFilled = React.forwardRef<SVGSVGElement, ToggleOnFilledProps>(
...
export const ToggleOnFilledMetadata = { 
  id: "toggle-on_filled", 
  baseId: "toggle-on", 
  variant: "filled", 
  name: "Toggle On", 
