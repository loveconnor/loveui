...
export interface PauseCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PauseCircleFilled = React.forwardRef<SVGSVGElement, PauseCircleFilledProps>(
...
export const PauseCircleFilledMetadata = { 
  id: "pause-circle_filled", 
  baseId: "pause-circle", 
  variant: "filled", 
  name: "Pause Circle", 
  category: "multimedia", 
