...
export interface GalleryImportFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GalleryImportFilled = React.forwardRef<SVGSVGElement, GalleryImportFilledProps>(
...
GalleryImportFilled.displayName = "GalleryImportFilled";
export const GalleryImportFilledMetadata = { 
  id: "gallery-import_filled", 
...
export default GalleryImportFilled;
