...
`;function L(e){if(!e)return e;let o=e.split("/");return o[o.length-1]||e}function ce(e){let o=e.trim();return o&&((o.startsWith("@/")||o.startsWith("~/"))&&(o=`src/${o.slice(2)}`),o.startsWith("/")&&(o=o.slice(1)),o=o.replace(/^\.\//,""),o=o.replace(/\/+$/,""),o)}function je(e){return e.trim().replace(/\/+$/,"")}function B(e){return e.replace(/\.(?:ts|tsx|js|jsx)$/i,"")}function Q(e){let o=B(e);return we.map(s=>`${o}${s}`)}function Pe(e){let o=e.replace(/\/+$/,"");return o==="src"||o.startsWith("src/")?"src":o==="app"||o.startsWith("app/")?"app":null}function ue(e){let o=L(e);return o==="ui"?"love-ui":o}function Se(e){let o=e.loveui??{},s=typeof o.target=="string"?o.target.trim():"",t=o.category;if(s){let i=typeof o.includePackageName=="boolean"?o.includePackageName:!1;return{base:s.replace(/\/+$/,""),includePackageName:i}}return t==="feature"?{base:"components",includePackageName:!0}:t==="block"?{base:"components/blocks",includePackageName:!0}:{base:"components/ui",includePackageName:!0}}function Be(e,o,s){let t=e.startsWith("src/")?e.slice(4):e;if(!o.includePackageName){let u=o.base.split("/").filter(Boolean),l=u[u.length-1];l&&t.startsWith(`${l}/`)&&(t=t.slice(l.length+1))}let a=`${(o.includePackageName?`${o.base}/${s}`:o.base).replace(/\/+/g,"/")}/${t}`.replace(/\/+/g,"/");return{cleanedPath:t,target:a}}async function Te(e){let o=r.join(e,"components.json");try{let s=await h(o,"utf8");return JSON.parse(s).aliases??null}catch{return null}}async function Re(e){let o=["tsconfig.json","jsconfig.json"].map(s=>r.join(e,s)).find(s=>g(s));if(!o)return null;try{let s=await h(o,"utf8"),i=JSON.parse(s).compilerOptions?.paths;return!i||typeof i!="object"?null:i}catch{return null}}function Fe(e,o){if(typeof e=="string"){if(e.trim().startsWith("~/"))return"~/";if(e.trim().startsWith("@/"))return"@/"}if(o){if(Object.prototype.hasOwnProperty.call(o,"~/*"))return"~/";if(Object.prototype.hasOwnProperty.call(o,"@/*"))return"@/"}return"@/"}async function Ue(e,o,s){if(o&&o.length>0)return o;let t=["src/components/ui","app/components/ui","components/ui"];for(let n of t)if(g(r.join(e,n)))return n.replace(/\/ui$/,"");let i=["src/components","app/components","components"];for(let n of i)if(g(r.join(e,n)))return n;if(s){let n=s["@/*"]??s["~/*"]??[];if(Array.isArray(n)&&n.some(a=>/^\.?\/?src\//.test(a)))return"src/components";if(Array.isArray(n)&&n.some(a=>/^\.?\/?app\//.test(a)))return"app/components"}return g(r.join(e,"src"))?"src/components":g(r.join(e,"app"))?"app/components":"components"}async function Le(e,o,s,t){let i=t?.utils??(t?.lib?`${t.lib.replace(/\/+$/,"")}/utils`:void 0);if(i&&i.trim().length>0){let l=B(je(i)),d=B(ce(i));for(let p of Q(d))if(g(r.join(e,p)))return{utilsImportPath:l,utilsFilePath:p};return{utilsImportPath:l,utilsFilePath:`${d}.ts`}}let n=Pe(o),a=n?`${n}/lib/utils`:"lib/utils",u=Array.from(new Set([a,"src/lib/utils","app/lib/utils","lib/utils"]));for(let l of u)for(let d of Q(l))if(g(r.join(e,d)))return{utilsImportPath:`${s}lib/utils`,utilsFilePath:d};return{utilsImportPath:`${s}lib/utils`,utilsFilePath:`${a}.ts`}}function Z(e,o,s){let t=a=>{let u=a.startsWith("/"),l=a.endsWith("/"),d=a.split("/").filter(Boolean),p=[];for(let x of d)p[p.length-1]!==x&&p.push(x);let w=p.join("/");return`${u?"/":""}${w}${l?"/":""}`},i=o.replace(/\/+$/,""),n=e.replace(/^\.?\//,"");if(le.test(n))return t(s);if(n.startsWith("components/")){let a=n.slice(10);return t(`${i}${a}`.replace(/^\//,""))}if(n.startsWith("lib/")){if(i.startsWith("src/"))return t(`src/${n}`);if(i.startsWith("app/"))return t(`app/${n}`)}if(n.startsWith("hooks/")){if(i.startsWith("src/"))return t(`src/${n}`);if(i.startsWith("app/"))return t(`app/${n}`)}return n.startsWith("ui/")?t(`${i}/${n}`):t(n)}function U(e,o){let s=o.startsWith("~/")?"~/":"@/",t=e;return t=t.replace(/@\/registry\/default\/components\//g,`${s}components/`),t=t.replace(/@\/registry\/default\/ui\//g,`${s}components/ui/`),t=t.replace(/@\/registry\/default\/hooks\//g,`${s}hooks/`),t=t.replace(/@\/registry\/default\/lib\//g,`${s}lib/`),t=t.replace(/@loveui\/ui\/ui\//g,`${s}components/ui/`),t=t.replace(/@loveui\/ui\/lib\//g,`${s}lib/`),t=t.replace(/@\/ui\//g,`${s}components/ui/`),t=t.replace(/@\/registry\/building-blocks\/default\/components\//g,`${s}components/`),t=t.replace(/@\/registry\/building-blocks\/default\/ui\//g,`${s}components/ui/`),t=t.replace(/@\/registry\/building-blocks\/default\/lib\//g,`${s}lib/`),t=t.replace(/@\/registry\/building-blocks\/default\/hooks\//g,`${s}hooks/`),t=t.replace(/@\/registry\/default\/components\//g,`${s}components/`),t=t.replace(/@\/registry\/default\/ui\//g,`${s}components/ui/`),t=t.replace(/@\/registry\/default\/lib\//g,`${s}lib/`),t=t.replace(/@\/registry\/default\/hooks\//g,`${s}hooks/`),t=t.replace(/from\s+["']@loveui\/ui\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["']@loveui\/shadcn-ui\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["']@love-ui\/shadcn-ui\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["']@\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["']~\/lib\/utils["']/g,`from "${o}"`),t=t.replace(/from\s+["'](?:\.\.\/)+ui\/src\/lib\/utils["']/g,`from "${o}"`),t}async function Ce(e,o){if(g(r.join(e,o)))return!1;let s=$e,t=r.join(z,"love-ui","src","lib","utils.ts");if(g(t))try{s=await h(t,"utf8")}catch{}return await M(o,e),await T(r.join(e,o),s,"utf8"),!0}async function Ee(e){let s=["app/globals.css","app/global.css","src/app/globals.css","src/app/global.css","styles/globals.css","src/styles/globals.css","globals.css","global.css"].find(l=>g(r.join(e,l)));s||(g(r.join(e,"src","app"))?s="src/app/globals.css":g(r.join(e,"app"))?s="app/globals.css":g(r.join(e,"src"))?s="src/styles/globals.css":s="globals.css");let t=r.join(e,s),i=g(t),n=i?await h(t,"utf8"):"",a=!1;/@import\s+["']tailwindcss["']/.test(n)||(n=`@import "tailwindcss";
${n?`
${n}`:""}`,a=!0),n.includes(xe)||(n=`${n.trimEnd()}

${De}`,a=!0),(!i||a)&&(await M(s,e),await T(t,n,"utf8"));let u=await Ie(e,s);return{path:s,created:!i,updated:a,imported:u}}async function Ie(e,o){let t=["app/layout.tsx","app/layout.jsx","src/app/layout.tsx","src/app/layout.jsx"].find(l=>g(r.join(e,l)));if(!t)return!1;let i=r.join(e,t),n=await h(i,"utf8"),a=Ae(r.dirname(t),o);if(n.includes(`"${a}"`)||n.includes(`'${a}'`))return!1;let u=`import "${a}";
${n}`;return await T(i,u,"utf8"),!0}function Ae(e,o){let s=r.posix.relative(e||".",o);return s.startsWith(".")||(s=`./${s}`),s}async function M(e,o){let s=r.dirname(r.join(o,e));await R(s,{recursive:!0})}async function Oe(e,o){let s=r.join(e,"package.json"),t={};try{let l=await h(s,"utf8");t=JSON.parse(l)}catch{}let i=Se(t),n=L(o),a=[];async function u(l,d){let p=await se(l,{withFileTypes:!0});for(let w of p){if(V.has(w.name))continue;let x=r.join(l,w.name);if(w.isDirectory()){await u(x,d);continue}let P=r.extname(w.name);if(!re.has(P)||w.name==="package.json")continue;let j=r.relative(d,x).split(r.sep).join("/"),{target:D}=Be(j,i,n),y=await h(x,"utf8");a.push({path:j,target:D,content:y})}}return await u(e,e),a}async function _e(e,o){let s=ae.get(e);if(!s)return null;let t=r.join(F,"default","blocks",s.sourceDir);if(!g(t))return null;try{let i=[],n=[],a=new Set;async function u(l){let d=await se(l,{withFileTypes:!0});for(let p of d){if(V.has(p.name))continue;let w=r.join(l,p.name);if(p.isDirectory()){await u(w);continue}let x=r.extname(p.name);if(!re.has(x))continue;let P=r.relative(t,w).split(r.sep).join("/"),j=await h(w,"utf8");for(let D of j.matchAll(/@\/registry\/default\/ui\/([^"']+)/g)){let y=D[1];y&&a.add(y)}n.push({path:`default/blocks/${s.sourceDir}/${P}`,target:`${s.targetBase}/${P}`,content:j})}}await u(t);for(let l of Array.from(a).sort((d,p)=>d.localeCompare(p))){let d=await K(l,o);d&&i.push(...d)}return i.push(...n),i}catch(i){return console.warn(`Warning: unable to read ${e} from bundled blocks`,i),null}}async function K(e,o){let s=r.join(F,"default","ui",`${e}.tsx`);if(g(s))try{let n=U(await h(s,"utf8"),o),a=[{path:`default/ui/${e}.tsx`,target:`components/ui/${e}.tsx`,content:n}];if(e==="toast"){let u=["toast-gooey.tsx","toast-gooey-renderer.tsx","toast-gooey-icons.tsx","toast-gooey-types.ts","toast-gooey.css"];for(let l of u){let d=r.join(F,"default","ui",l);g(d)&&a.push({path:`default/ui/${l}`,target:`components/ui/${l}`,content:await h(d,"utf8")})}}return a}catch(n){console.warn(`Warning: unable to read ${e} from bundled registry`,n)}let t=r.join(z,"love-ui"),i=r.join(t,"src","ui",`${e}.tsx`);if(!g(i))return null;try{let n=[],a=await h(i,"utf8");a=U(a,o),n.push({path:`src/ui/${e}.tsx`,target:`components/ui/${e}.tsx`,content:a});let u=r.join(t,"src","lib","utils.ts");if(g(u)){let l=await h(u,"utf8");n.push({path:"src/lib/utils.ts",target:"lib/utils.ts",content:l})}return n}catch(n){return console.warn(`Warning: unable to read ${e} component`,n),null}}async function We(e,o){if(ie.has(e))return await K(e,o);let s=r.join(F,"default","examples",`${e}.tsx`);if(g(s))try{let a=await h(s,"utf8"),u=[],l=Array.from(new Set([...a.matchAll(/@\/registry\/default\/ui\/([^"']+)/g)].map(d=>d[1]).filter(Boolean)));for(let d of l){let p=await K(d,o);p&&u.push(...p)}return u.push({path:`default/examples/${e}.tsx`,target:`components/${e}.tsx`,content:U(a,o)}),u}catch(a){return console.warn(`Warning: unable to read ${e} from bundled registry examples`,a),null}let t=await _e(e,o);if(t)return t;let i=ue(e),n=r.join(z,i);if(!g(n))return null;try{return await Oe(n,e)}catch(a){return console.warn(`Warning: unable to read bundled sources for ${e}`,a),null}}async function ge(e){let o=r.join(ke,L(e));return!g(o)||!g(r.join(o,"SKILL.md"))?null:o}var q=["codex","claude","cursor","github"],ee=new Set(q);function qe(){let e=process.env.CODEX_HOME?.trim();return e||r.join(ne.homedir(),".codex")}function Me(){let e=process.env.CLAUDE_HOME?.trim();return e||r.join(ne.homedir(),".claude")}async function _(e,o){let s=await ge(e);if(!s)throw new Error(`Bundled skill "${e}" was not found in this love-ui package.`);return await R(r.dirname(o),{recursive:!0}),g(o)?"exists":(await pe(s,o,{recursive:!0,force:!1,filter:t=>{let i=r.basename(t);return!V.has(i)}}),"installed")}async function te(e,o){return await R(r.dirname(e),{recursive:!0}),g(e)?"exists":(await T(e,o,"utf8"),"installed")}function ze(e){return`---
...
Adding ${s} for ${i.join(", ")}...`);for(let n of i){let a=await He(s,n,o);for(let u of a){let l=u.status==="installed"?"Installed":"Already exists";console.log(`\u2713 ${l}: ${u.label} at ${u.path}`)}}console.log(`
...
`),!0)}async function Qe(e=process.argv.slice(2)){if((e.length===0||e.length===1&&(e[0]==="--version"||e[0]==="-v"))&&(console.log("love-ui version 1.1.9"),process.exit(0)),(e.length<2||e[0]!=="add")&&(console.log("Usage: npx love-ui add [...packages]"),console.log("       npx love-ui add loveui-skills [codex|claude|cursor|github|all]"),console.log("       npx love-ui add loveui-skills --agent codex"),console.log("       npx love-ui --version"),process.exit(1)),L(e[1]??"")==="loveui-skills"){await Ve(e.slice(2),process.cwd());return}let o=e.slice(1),s=process.cwd(),t=await Te(s),i=await Re(s),n=t?.components?ce(t.components):null,a=await Ue(s,n,i),u=Fe(t?.components,i),{utilsImportPath:l,utilsFilePath:d}=await Le(s,a,u,t),p=await Ye(s),w=a.endsWith("/ui")?a:`${a}/ui`,x=!1,P=!1,j=!1,D={};for(let y of o){if(!y.trim())continue;if(console.log(`
Adding ${y}...`),x||(await R(r.join(s,a),{recursive:!0}),await R(r.join(s,w),{recursive:!0}),x=!0),!j){let c=await Ee(s);c.created?console.log(`\u2713 Created ${c.path}`):c.updated&&console.log(`\u2713 Updated ${c.path}`),c.imported&&console.log(`\u2713 Imported ${c.path} from app layout`),j=!0}P=!0;let m=null,X=null;if(y.startsWith("http://")||y.startsWith("https://")){let c=y;c.includes("/building-blocks/r/")&&(c=c.replace("/building-blocks/r/","/building-blocks/"),console.log(`Auto-corrected URL to: ${c}`));try{let f=await fetch(c);f.ok?m=await f.json():console.warn(`Failed to fetch ${c}: HTTP ${f.status}`)}catch(f){console.warn(`Failed to fetch from ${c}:`,f)}}else{let c=new URL(`r/${y}.json`,"https://www.loveui.dev/");try{let f=await fetch(c);f.ok&&(m=await f.json())}catch{}X=await We(y,l)}let S=X??m?.files??[];S=S.map(c=>{let f=c.target||c.path;return f.startsWith("registry/default/")&&(f=f.replace("registry/default/","")),{...c,target:f}});let C=S.find(c=>c.target.match(/^components\/comp-\d+\.tsx$/));if(C){let c=S.filter(f=>f.target.match(/^components\/[^/]+\//)&&f.target!==C.target);if(c.length>0&&c[0]){let f=c[0].target.match(/^components\/([^/]+)\//);if(f&&f[1]){let b=f[1];C.target=`components/${b}-demo.tsx`}}else if(m?.meta?.tags&&Array.isArray(m.meta.tags)&&m.meta.tags.length>0){let b=m.meta.tags.slice(0,2).filter(v=>v.length>0);if(b.length>0){let v=b.join("-").toLowerCase().replace(/\s+/g,"-");C.target=`components/${v}.tsx`}}}if(!S.length){console.warn(`Component "${y}" not found. Available components can be found at https://loveui.dev`);continue}S.some(c=>le.test(c.target)||typeof c.content=="string"&&ve.test(c.content))&&await Ce(s,d);let E=0,I=0;for(let c of S){if(!c.content)continue;let f=Z(c.target,a,d),b=r.join(s,f),v=g(b);if(B(f)===B(d)&&v)continue;let O=U(c.content,l);if(v)try{if(await h(b,"utf8")===O)continue}catch{}await M(f,s),await T(b,O,"utf8"),v?I++:E++}if(E>0&&console.log(`\u2713 Created ${E} file${E>1?"s":""}`),I>0&&console.log(`\u2713 Updated ${I} file${I>1?"s":""}`),m?.registryDependencies&&m.registryDependencies.length>0){console.log(`
Installing ${m.registryDependencies.length} required component${m.registryDependencies.length>1?"s":""}...`);for(let c of m.registryDependencies){let f=c;c.startsWith("https://loveui.dev/building-blocks/r/")&&(f=`https://ui.loveui.dev/ui/r/${c.split("/").pop()}`);try{let b=await fetch(f);if(b.ok){let v=await b.json(),O=(v?.files??[]).map(k=>{let $=k.target||k.path;return $.startsWith("registry/default/")&&($=$.replace("registry/default/","")),{...k,target:$}});for(let k of O){if(!k.content)continue;let $=Z(k.target,a,d),H=r.join(s,$),Y=g(H);if(B($)===B(d)&&Y)continue;let N=U(k.content,l);if(Y)try{if(await h(H,"utf8")===N)continue}catch{}await M($,s),await T(H,N,"utf8")}let G=["@loveui/shadcn-ui","jotai","lucide-react","react","react-dom"];if(v?.dependencies)if(Array.isArray(v.dependencies))v.dependencies.forEach(k=>{G.includes(k)||(D[k]="latest")});else{let k=v.dependencies;Object.keys(k).forEach($=>{!G.includes($)&&k[$]&&(D[$]=k[$])})}}else console.warn(`  \u2717 Failed to fetch ${f}: HTTP ${b.status}`)}catch(b){console.warn(`  \u2717 Failed to install ${f}:`,b.message)}}console.log("\u2713 Installed registry dependencies")}let A={};m?.dependencies?Array.isArray(m.dependencies)?m.dependencies.forEach(c=>{A[c]="latest"}):A=m.dependencies:A=await Xe(y),Object.assign(D,A)}Object.keys(D).length>0&&await Ne(D,p,s),console.log(P?`
