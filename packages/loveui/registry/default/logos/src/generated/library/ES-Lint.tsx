...
export interface ESLintProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const ESLint = React.forwardRef<SVGSVGElement, ESLintProps>(
