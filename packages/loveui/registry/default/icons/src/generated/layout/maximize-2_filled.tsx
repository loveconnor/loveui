...
export interface Maximize2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Maximize2Filled = React.forwardRef<SVGSVGElement, Maximize2FilledProps>(
...
Maximize2Filled.displayName = "Maximize2Filled";
export const Maximize2FilledMetadata = { 
  id: "maximize-2_filled", 
  baseId: "maximize-2", 
  variant: "filled", 
  name: "Maximize 2", 
  category: "layout", 
...
export default Maximize2Filled;
