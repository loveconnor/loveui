...
export interface SubtitleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SubtitleFilled = React.forwardRef<SVGSVGElement, SubtitleFilledProps>(
...
SubtitleFilled.displayName = "SubtitleFilled";
export const SubtitleFilledMetadata = { 
  id: "subtitle_filled", 
  baseId: "subtitle", 
  variant: "filled", 
  name: "Subtitle", 
