...
export interface ChartFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChartFilled = React.forwardRef<SVGSVGElement, ChartFilledProps>(
...
export const ChartFilledMetadata = { 
  id: "chart_filled", 
  baseId: "chart", 
  variant: "filled", 
  name: "Chart", 
