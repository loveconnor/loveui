...
export interface QuoteUpSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const QuoteUpSquareFilled = React.forwardRef<SVGSVGElement, QuoteUpSquareFilledProps>(
...
QuoteUpSquareFilled.displayName = "QuoteUpSquareFilled";
export const QuoteUpSquareFilledMetadata = { 
  id: "quote-up-square_filled", 
...
export default QuoteUpSquareFilled;
