...
export interface ChartFailFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChartFailFilled = React.forwardRef<SVGSVGElement, ChartFailFilledProps>(
...
ChartFailFilled.displayName = "ChartFailFilled";
export const ChartFailFilledMetadata = { 
  id: "chart-fail_filled", 
  baseId: "chart-fail", 
  variant: "filled", 
  name: "Chart Fail", 
  category: "business", 
...
export default ChartFailFilled;
