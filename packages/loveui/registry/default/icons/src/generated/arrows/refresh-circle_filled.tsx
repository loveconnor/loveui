...
export interface RefreshCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RefreshCircleFilled = React.forwardRef<SVGSVGElement, RefreshCircleFilledProps>(
...
RefreshCircleFilled.displayName = "RefreshCircleFilled";
export const RefreshCircleFilledMetadata = { 
  id: "refresh-circle_filled", 
