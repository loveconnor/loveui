...
export interface HospitalFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HospitalFilled = React.forwardRef<SVGSVGElement, HospitalFilledProps>(
...
export const HospitalFilledMetadata = { 
  id: "hospital_filled", 
  baseId: "hospital", 
  variant: "filled", 
  name: "Hospital", 
