...
export interface CardSendFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CardSendFilled = React.forwardRef<SVGSVGElement, CardSendFilledProps>(
...
CardSendFilled.displayName = "CardSendFilled";
export const CardSendFilledMetadata = { 
  id: "card-send_filled", 
  baseId: "card-send", 
  variant: "filled", 
  name: "Card Send", 
