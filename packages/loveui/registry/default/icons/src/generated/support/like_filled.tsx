...
export interface LikeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LikeFilled = React.forwardRef<SVGSVGElement, LikeFilledProps>(
...
export const LikeFilledMetadata = { 
  id: "like_filled", 
  baseId: "like", 
  variant: "filled", 
  name: "Like", 
