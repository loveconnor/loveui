    ...
    <div className="flex min-h-dvh items-center justify-center bg-background p-4">
      <div className="w-full max-w-xl">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-foreground">LoveUI setup</h3>
          <Button
            className={
        ...
        <p className="mt-1 text-muted-foreground text-sm leading-6">
          Turning a copied block into a polished production screen.
        </p>
                      ...
                      <div>
                        ...
                        {step.type === 'created' ? (
                          <p className="text-muted-foreground text-sm leading-6">
                            Finished on {step.createdOn}, Runtime: {step.runTime}
                          </p>
                        ) : (
                          <p className="text-muted-foreground text-sm leading-6">
                            Checking layout, copy, and interaction states...
                          </p>
                        )}
                      </div>
                    </div>
