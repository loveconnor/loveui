...
export interface MusicPlaylistFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MusicPlaylistFilled = React.forwardRef<SVGSVGElement, MusicPlaylistFilledProps>(
...
<path d="M13.91 16.21C13.57 16.21 13.29 16.49 13.29 16.83C13.29 17.17 13.57 17.45 13.91 17.45C14.25 17.45 14.53 17.17 14.53 16.83C14.53 16.49 14.25 16.21 13.91 16.21Z" fill="currentColor"/>
<path d="M9.51002 17.7399C9.51002 17.3999 9.23002 17.1299 8.89002 17.1299C8.55002 17.1299 8.27002 17.4099 8.27002 17.7499C8.27002 18.0899 8.55002 18.3699 8.89002 18.3699C9.23002 18.3599 9.51002 18.0799 9.51002 17.7399Z" fill="currentColor"/>
...
MusicPlaylistFilled.displayName = "MusicPlaylistFilled";
export const MusicPlaylistFilledMetadata = { 
  id: "music-playlist_filled", 
...
export default MusicPlaylistFilled;
