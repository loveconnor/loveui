...
export interface GameboyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GameboyFilled = React.forwardRef<SVGSVGElement, GameboyFilledProps>(
...
GameboyFilled.displayName = "GameboyFilled";
export const GameboyFilledMetadata = { 
  id: "gameboy_filled", 
  baseId: "gameboy", 
  variant: "filled", 
  name: "Gameboy", 
