...
export interface Scribble121SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble121Sketch = React.forwardRef<SVGSVGElement, Scribble121SketchProps>(
...
export default Scribble121Sketch;
