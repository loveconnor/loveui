...
export interface NotificationStatusFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const NotificationStatusFilled = React.forwardRef<SVGSVGElement, NotificationStatusFilledProps>(
...
NotificationStatusFilled.displayName = "NotificationStatusFilled";
export const NotificationStatusFilledMetadata = { 
  id: "notification-status_filled", 
...
export default NotificationStatusFilled;
