...
export interface Scribble136SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble136Sketch = React.forwardRef<SVGSVGElement, Scribble136SketchProps>(
...
export default Scribble136Sketch;
