...
export interface ExportFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ExportFilled = React.forwardRef<SVGSVGElement, ExportFilledProps>(
...
export const ExportFilledMetadata = { 
  id: "export_filled", 
  baseId: "export", 
  variant: "filled", 
  name: "Export", 
