...
export interface ReceiptAddFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptAddFilled = React.forwardRef<SVGSVGElement, ReceiptAddFilledProps>(
...
ReceiptAddFilled.displayName = "ReceiptAddFilled";
export const ReceiptAddFilledMetadata = { 
  id: "receipt-add_filled", 
  baseId: "receipt-add", 
  variant: "filled", 
  name: "Receipt Add", 
  category: "finance", 
