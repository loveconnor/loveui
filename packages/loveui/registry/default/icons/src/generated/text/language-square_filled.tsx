...
export interface LanguageSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LanguageSquareFilled = React.forwardRef<SVGSVGElement, LanguageSquareFilledProps>(
...
LanguageSquareFilled.displayName = "LanguageSquareFilled";
export const LanguageSquareFilledMetadata = { 
  id: "language-square_filled", 
...
export default LanguageSquareFilled;
