...
export interface Profile2userFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Profile2userFilled = React.forwardRef<SVGSVGElement, Profile2userFilledProps>(
...
Profile2userFilled.displayName = "Profile2userFilled";
export const Profile2userFilledMetadata = { 
  id: "profile-2user_filled", 
