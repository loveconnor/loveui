...
export interface AirplaneFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AirplaneFilled = React.forwardRef<SVGSVGElement, AirplaneFilledProps>(
