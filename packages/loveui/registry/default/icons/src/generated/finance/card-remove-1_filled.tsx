...
export interface CardRemove1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CardRemove1Filled = React.forwardRef<SVGSVGElement, CardRemove1FilledProps>(
...
<path d="M13.5 4.6099V7.5399C13.5 8.2099 12.96 8.7499 12.29 8.7499H3.21C2.53 8.7499 2 8.1899 2 7.5199C2.01 6.3899 2.46 5.3599 3.21 4.6099C3.96 3.8599 5 3.3999 6.14 3.3999H12.29C12.96 3.3999 13.5 3.9399 13.5 4.6099Z" fill="currentColor"/>
...
CardRemove1Filled.displayName = "CardRemove1Filled";
export const CardRemove1FilledMetadata = { 
  id: "card-remove-1_filled", 
...
export default CardRemove1Filled;
