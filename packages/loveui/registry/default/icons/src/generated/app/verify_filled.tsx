...
export interface VerifyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VerifyFilled = React.forwardRef<SVGSVGElement, VerifyFilledProps>(
