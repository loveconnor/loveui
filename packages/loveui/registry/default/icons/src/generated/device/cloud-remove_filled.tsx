...
export interface CloudRemoveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CloudRemoveFilled = React.forwardRef<SVGSVGElement, CloudRemoveFilledProps>(
...
<path d="M20.1999 17.29C19.8399 17.61 19.4499 17.88 19.0299 18.1C18.6699 18.28 18.3099 17.93 18.3699 17.53C18.41 17.24 18.4299 16.94 18.4299 16.63C18.4299 13.05 15.5099 10.13 11.9299 10.13C8.34995 10.13 5.42995 13.05 5.42995 16.63C5.42995 17.09 5.47995 17.53 5.56995 17.96C5.63995 18.31 5.36995 18.66 5.01995 18.57C1.06995 17.61 1.04995 11.53 5.46995 11.21H5.51995C2.30995 2.28996 15.8499 -1.28004 17.3999 8.09996C21.7299 8.64996 23.4799 14.42 20.1999 17.29Z" fill="currentColor"/>
    </svg>
  )
);
CloudRemoveFilled.displayName = "CloudRemoveFilled";
export const CloudRemoveFilledMetadata = { 
  id: "cloud-remove_filled", 
  baseId: "cloud-remove", 
  variant: "filled", 
  name: "Cloud Remove", 
  category: "device", 
...
export default CloudRemoveFilled;
