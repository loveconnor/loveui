...
export interface LinkFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LinkFilled = React.forwardRef<SVGSVGElement, LinkFilledProps>(
...
export const LinkFilledMetadata = { 
  id: "link_filled", 
  baseId: "link", 
  variant: "filled", 
  name: "Link", 
