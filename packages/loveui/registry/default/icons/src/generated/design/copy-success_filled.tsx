...
export interface CopySuccessFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CopySuccessFilled = React.forwardRef<SVGSVGElement, CopySuccessFilledProps>(
...
CopySuccessFilled.displayName = "CopySuccessFilled";
export const CopySuccessFilledMetadata = { 
  id: "copy-success_filled", 
  baseId: "copy-success", 
  variant: "filled", 
  name: "Copy Success", 
  category: "design", 
...
export default CopySuccessFilled;
