...
export interface NavigationDoodleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const NavigationDoodle = React.forwardRef<SVGSVGElement, NavigationDoodleProps>(
...
export default NavigationDoodle;
