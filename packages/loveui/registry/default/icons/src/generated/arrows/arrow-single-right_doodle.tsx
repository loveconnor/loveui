...
export interface ArrowSingleRightDoodleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowSingleRightDoodle = React.forwardRef<SVGSVGElement, ArrowSingleRightDoodleProps>(
...
export default ArrowSingleRightDoodle;
