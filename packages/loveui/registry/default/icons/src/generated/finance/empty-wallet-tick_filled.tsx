...
export interface EmptyWalletTickFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EmptyWalletTickFilled = React.forwardRef<SVGSVGElement, EmptyWalletTickFilledProps>(
...
EmptyWalletTickFilled.displayName = "EmptyWalletTickFilled";
export const EmptyWalletTickFilledMetadata = { 
  id: "empty-wallet-tick_filled", 
...
export default EmptyWalletTickFilled;
