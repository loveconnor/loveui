...
export interface ReceiptTextFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptTextFilled = React.forwardRef<SVGSVGElement, ReceiptTextFilledProps>(
...
ReceiptTextFilled.displayName = "ReceiptTextFilled";
export const ReceiptTextFilledMetadata = { 
  id: "receipt-text_filled", 
  baseId: "receipt-text", 
  variant: "filled", 
  name: "Receipt Text", 
  category: "finance", 
...
export default ReceiptTextFilled;
