...
export interface EmptyWalletFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EmptyWalletFilled = React.forwardRef<SVGSVGElement, EmptyWalletFilledProps>(
...
EmptyWalletFilled.displayName = "EmptyWalletFilled";
export const EmptyWalletFilledMetadata = { 
  id: "empty-wallet_filled", 
  baseId: "empty-wallet", 
  variant: "filled", 
  name: "Empty Wallet", 
  category: "finance", 
...
export default EmptyWalletFilled;
