...
export interface TrushSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TrushSquareFilled = React.forwardRef<SVGSVGElement, TrushSquareFilledProps>(
...
TrushSquareFilled.displayName = "TrushSquareFilled";
export const TrushSquareFilledMetadata = { 
  id: "trush-square_filled", 
  baseId: "trush-square", 
  variant: "filled", 
  name: "Trush Square", 
  category: "app", 
...
export default TrushSquareFilled;
