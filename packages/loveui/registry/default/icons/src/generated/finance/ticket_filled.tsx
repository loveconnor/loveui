...
export interface TicketFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TicketFilled = React.forwardRef<SVGSVGElement, TicketFilledProps>(
...
export const TicketFilledMetadata = { 
  id: "ticket_filled", 
  baseId: "ticket", 
  variant: "filled", 
  name: "Ticket", 
