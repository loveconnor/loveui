...
export interface MirroringScreenFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MirroringScreenFilled = React.forwardRef<SVGSVGElement, MirroringScreenFilledProps>(
...
MirroringScreenFilled.displayName = "MirroringScreenFilled";
export const MirroringScreenFilledMetadata = { 
  id: "mirroring-screen_filled", 
...
export default MirroringScreenFilled;
