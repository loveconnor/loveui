...
export interface CodeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CodeFilled = React.forwardRef<SVGSVGElement, CodeFilledProps>(
...
export const CodeFilledMetadata = { 
  id: "code_filled", 
  baseId: "code", 
  variant: "filled", 
  name: "Code", 
