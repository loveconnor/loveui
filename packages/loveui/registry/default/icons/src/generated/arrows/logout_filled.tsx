...
export interface LogoutFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LogoutFilled = React.forwardRef<SVGSVGElement, LogoutFilledProps>(
...
<path d="M4.55994 11.2501L6.62994 9.18009C6.77994 9.03009 6.84994 8.84009 6.84994 8.65009C6.84994 8.46009 6.77994 8.26009 6.62994 8.12009C6.33994 7.83009 5.85994 7.83009 5.56994 8.12009L2.21994 11.4701C1.92994 11.7601 1.92994 12.2401 2.21994 12.5301L5.56994 15.8801C5.85994 16.1701 6.33994 16.1701 6.62994 15.8801C6.91994 15.5901 6.91994 15.1101 6.62994 14.8201L4.55994 12.7501H8.99994V11.2501H4.55994Z" fill="currentColor"/>
    </svg>
  )
);
LogoutFilled.displayName = "LogoutFilled";
export const LogoutFilledMetadata = { 
  id: "logout_filled", 
  baseId: "logout", 
  variant: "filled", 
  name: "Logout", 
