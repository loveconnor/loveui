...
export interface Receipt2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Receipt2Filled = React.forwardRef<SVGSVGElement, Receipt2FilledProps>(
...
Receipt2Filled.displayName = "Receipt2Filled";
export const Receipt2FilledMetadata = { 
  id: "receipt-2_filled", 
  baseId: "receipt-2", 
  variant: "filled", 
  name: "Receipt 2", 
