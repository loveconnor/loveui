...
export interface FilterRemoveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FilterRemoveFilled = React.forwardRef<SVGSVGElement, FilterRemoveFilledProps>(
...
FilterRemoveFilled.displayName = "FilterRemoveFilled";
export const FilterRemoveFilledMetadata = { 
  id: "filter-remove_filled", 
