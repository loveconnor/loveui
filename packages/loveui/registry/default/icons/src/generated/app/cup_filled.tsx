...
export interface CupFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CupFilled = React.forwardRef<SVGSVGElement, CupFilledProps>(
...
CupFilled.displayName = "CupFilled";
export const CupFilledMetadata = { 
  id: "cup_filled", 
  baseId: "cup", 
  variant: "filled", 
  name: "Cup", 
