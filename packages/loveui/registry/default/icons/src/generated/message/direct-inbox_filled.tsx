...
export interface DirectInboxFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DirectInboxFilled = React.forwardRef<SVGSVGElement, DirectInboxFilledProps>(
...
DirectInboxFilled.displayName = "DirectInboxFilled";
export const DirectInboxFilledMetadata = { 
  id: "direct-inbox_filled", 
  baseId: "direct-inbox", 
  variant: "filled", 
  name: "Direct Inbox", 
  category: "message", 
...
export default DirectInboxFilled;
