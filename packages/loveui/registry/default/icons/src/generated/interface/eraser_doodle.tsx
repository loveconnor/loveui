...
export interface EraserDoodleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EraserDoodle = React.forwardRef<SVGSVGElement, EraserDoodleProps>(
...
<defs>
<clipPath id="clip0">
<rect width="127" height="117" fill="currentColor" transform="translate(0.777344)"/>
</clipPath>
</defs>
    </svg>
  )
);
EraserDoodle.displayName = "EraserDoodle";
export const EraserDoodleMetadata = { 
  id: "eraser_doodle", 
  baseId: "eraser", 
  variant: "doodle", 
  name: "Eraser", 
