...
export interface DriverRefreshFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DriverRefreshFilled = React.forwardRef<SVGSVGElement, DriverRefreshFilledProps>(
...
DriverRefreshFilled.displayName = "DriverRefreshFilled";
export const DriverRefreshFilledMetadata = { 
  id: "driver-refresh_filled", 
...
export default DriverRefreshFilled;
