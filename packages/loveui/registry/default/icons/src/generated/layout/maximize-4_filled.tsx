...
export interface Maximize4FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Maximize4Filled = React.forwardRef<SVGSVGElement, Maximize4FilledProps>(
...
Maximize4Filled.displayName = "Maximize4Filled";
export const Maximize4FilledMetadata = { 
  id: "maximize-4_filled", 
  baseId: "maximize-4", 
  variant: "filled", 
  name: "Maximize 4", 
  category: "layout", 
...
export default Maximize4Filled;
