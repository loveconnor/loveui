...
export interface RedoFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RedoFilled = React.forwardRef<SVGSVGElement, RedoFilledProps>(
...
RedoFilled.displayName = "RedoFilled";
export const RedoFilledMetadata = { 
  id: "redo_filled", 
  baseId: "redo", 
  variant: "filled", 
  name: "Redo", 
