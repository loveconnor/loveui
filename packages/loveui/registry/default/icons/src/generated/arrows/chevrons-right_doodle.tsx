...
export interface ChevronsRightDoodleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChevronsRightDoodle = React.forwardRef<SVGSVGElement, ChevronsRightDoodleProps>(
...
export default ChevronsRightDoodle;
