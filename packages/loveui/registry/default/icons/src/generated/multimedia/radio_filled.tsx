...
export interface RadioFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RadioFilled = React.forwardRef<SVGSVGElement, RadioFilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M7.75 2V5H7C6.74 5 6.49 5.01 6.25 5.05V2C6.25 1.59 6.59 1.25 7 1.25C7.41 1.25 7.75 1.59 7.75 2Z" fill="currentColor"/>
...
RadioFilled.displayName = "RadioFilled";
export const RadioFilledMetadata = { 
  id: "radio_filled", 
  baseId: "radio", 
  variant: "filled", 
  name: "Radio", 
