...
export interface HierarchySquare2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HierarchySquare2Filled = React.forwardRef<SVGSVGElement, HierarchySquare2FilledProps>(
...
HierarchySquare2Filled.displayName = "HierarchySquare2Filled";
export const HierarchySquare2FilledMetadata = { 
  id: "hierarchy-square-2_filled", 
...
export default HierarchySquare2Filled;
