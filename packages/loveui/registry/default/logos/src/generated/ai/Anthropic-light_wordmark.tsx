...
export interface AnthropicLightWordmarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const AnthropicLightWordmark = React.forwardRef<SVGSVGElement, AnthropicLightWordmarkProps>(
...
export default AnthropicLightWordmark;
