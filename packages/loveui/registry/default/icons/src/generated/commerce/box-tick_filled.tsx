...
export interface BoxTickFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BoxTickFilled = React.forwardRef<SVGSVGElement, BoxTickFilledProps>(
...
BoxTickFilled.displayName = "BoxTickFilled";
export const BoxTickFilledMetadata = { 
  id: "box-tick_filled", 
  baseId: "box-tick", 
  variant: "filled", 
  name: "Box Tick", 
