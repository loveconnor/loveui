...
export interface ReceiptMinusFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptMinusFilled = React.forwardRef<SVGSVGElement, ReceiptMinusFilledProps>(
...
ReceiptMinusFilled.displayName = "ReceiptMinusFilled";
export const ReceiptMinusFilledMetadata = { 
  id: "receipt-minus_filled", 
...
export default ReceiptMinusFilled;
