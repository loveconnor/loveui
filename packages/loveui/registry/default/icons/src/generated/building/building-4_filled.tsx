...
export interface Building4FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Building4Filled = React.forwardRef<SVGSVGElement, Building4FilledProps>(
...
Building4Filled.displayName = "Building4Filled";
export const Building4FilledMetadata = { 
  id: "building-4_filled", 
  baseId: "building-4", 
  variant: "filled", 
  name: "Building 4", 
  category: "building", 
