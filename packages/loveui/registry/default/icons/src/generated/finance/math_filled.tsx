...
export interface MathFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MathFilled = React.forwardRef<SVGSVGElement, MathFilledProps>(
...
MathFilled.displayName = "MathFilled";
export const MathFilledMetadata = { 
  id: "math_filled", 
  baseId: "math", 
  variant: "filled", 
  name: "Math", 
