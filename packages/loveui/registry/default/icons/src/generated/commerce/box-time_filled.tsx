...
export interface BoxTimeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BoxTimeFilled = React.forwardRef<SVGSVGElement, BoxTimeFilledProps>(
...
BoxTimeFilled.displayName = "BoxTimeFilled";
export const BoxTimeFilledMetadata = { 
  id: "box-time_filled", 
  baseId: "box-time", 
  variant: "filled", 
  name: "Box Time", 
