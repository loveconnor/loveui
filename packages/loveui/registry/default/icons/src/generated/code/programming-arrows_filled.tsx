...
export interface ProgrammingArrowsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ProgrammingArrowsFilled = React.forwardRef<SVGSVGElement, ProgrammingArrowsFilledProps>(
...
ProgrammingArrowsFilled.displayName = "ProgrammingArrowsFilled";
export const ProgrammingArrowsFilledMetadata = { 
  id: "programming-arrows_filled", 
...
export default ProgrammingArrowsFilled;
