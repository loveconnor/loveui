...
export interface ChevronsUpDoodleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChevronsUpDoodle = React.forwardRef<SVGSVGElement, ChevronsUpDoodleProps>(
...
export default ChevronsUpDoodle;
