...
export const CreditCard = ({ className, ...props }: CreditCardProps) => (
  <div
    className={cn(
      "group/loveui-credit-card perspective-distant aspect-[8560/5398] w-full max-w-96 text-white",
      "@container",
      className
    )}
    {...props}
    ...
    <CreditCardFlipContext.Provider value={true}>
      ...
      <div
        ...
        className={cn(
          ...
          supportsHover &&
            "group-hover/loveui-credit-card:-rotate-y-180 group-hover/loveui-credit-card:shadow-lg",
  ...
  children ? (
    ...
    >
      ...
      <path
        ...
        fill="url(#loveui-credit-card-chip-gradient)"
      />
      <path
      ...
      <defs>
        <linearGradient
          ...
          id="loveui-credit-card-chip-gradient"
          x1="1"
          x2="112.7"
          y1="46"
          y2="78.12"
