...
export interface DirectboxReceiveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DirectboxReceiveFilled = React.forwardRef<SVGSVGElement, DirectboxReceiveFilledProps>(
...
export default DirectboxReceiveFilled;
