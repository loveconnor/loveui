...
export interface ArrowCircleRightFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowCircleRightFilled = React.forwardRef<SVGSVGElement, ArrowCircleRightFilledProps>(
...
export const ArrowCircleRightFilledMetadata = { 
  id: "arrow-circle-right_filled", 
