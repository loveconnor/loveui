...
export interface CalendarSearchFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CalendarSearchFilled = React.forwardRef<SVGSVGElement, CalendarSearchFilledProps>(
...
CalendarSearchFilled.displayName = "CalendarSearchFilled";
export const CalendarSearchFilledMetadata = { 
  id: "calendar-search_filled", 
