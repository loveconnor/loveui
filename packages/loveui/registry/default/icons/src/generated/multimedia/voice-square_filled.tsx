...
export interface VoiceSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VoiceSquareFilled = React.forwardRef<SVGSVGElement, VoiceSquareFilledProps>(
...
VoiceSquareFilled.displayName = "VoiceSquareFilled";
export const VoiceSquareFilledMetadata = { 
  id: "voice-square_filled", 
  baseId: "voice-square", 
  variant: "filled", 
  name: "Voice Square", 
  category: "multimedia", 
...
export default VoiceSquareFilled;
