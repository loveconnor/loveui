...
export interface UserRemoveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const UserRemoveFilled = React.forwardRef<SVGSVGElement, UserRemoveFilledProps>(
...
export default UserRemoveFilled;
