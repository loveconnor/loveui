...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/loveui/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/loveui/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/loveui/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/loveui/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/loveui/Projects/foobar/lib/utils")
})
...
describe("resolve package imports", () => {
  ...
  test("falls back to tsconfig paths when package imports do not match", async () => {
    expect(
      ...
      path: "/Users/loveui/Projects/foobar/src/components/ui",
