...
export interface SimcardFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SimcardFilled = React.forwardRef<SVGSVGElement, SimcardFilledProps>(
...
SimcardFilled.displayName = "SimcardFilled";
export const SimcardFilledMetadata = { 
  id: "simcard_filled", 
  baseId: "simcard", 
  variant: "filled", 
  name: "Simcard", 
