...
export interface GalleryAddFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GalleryAddFilled = React.forwardRef<SVGSVGElement, GalleryAddFilledProps>(
...
GalleryAddFilled.displayName = "GalleryAddFilled";
export const GalleryAddFilledMetadata = { 
  id: "gallery-add_filled", 
  baseId: "gallery-add", 
  variant: "filled", 
  name: "Gallery Add", 
  category: "multimedia", 
...
export default GalleryAddFilled;
