...
export interface RepeatFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RepeatFilled = React.forwardRef<SVGSVGElement, RepeatFilledProps>(
...
RepeatFilled.displayName = "RepeatFilled";
export const RepeatFilledMetadata = { 
  id: "repeat_filled", 
  baseId: "repeat", 
  variant: "filled", 
  name: "Repeat", 
