...
export interface AudioSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AudioSquareFilled = React.forwardRef<SVGSVGElement, AudioSquareFilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M9.67009 13.9199C8.93009 13.9199 8.34009 14.5199 8.34009 15.2599C8.34009 15.9999 8.94009 16.5899 9.67009 16.5899C10.4101 16.5899 11.0101 15.9899 11.0101 15.2599C11.0101 14.5199 10.4101 13.9199 9.67009 13.9199Z" fill="currentColor"/>
...
AudioSquareFilled.displayName = "AudioSquareFilled";
export const AudioSquareFilledMetadata = { 
  id: "audio-square_filled", 
  baseId: "audio-square", 
  variant: "filled", 
  name: "Audio Square", 
  category: "multimedia", 
...
export default AudioSquareFilled;
