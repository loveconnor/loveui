...
export interface DataFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DataFilled = React.forwardRef<SVGSVGElement, DataFilledProps>(
...
DataFilled.displayName = "DataFilled";
export const DataFilledMetadata = { 
  id: "data_filled", 
  baseId: "data", 
  variant: "filled", 
  name: "Data", 
