...
export interface MonitorRecorderFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MonitorRecorderFilled = React.forwardRef<SVGSVGElement, MonitorRecorderFilledProps>(
...
MonitorRecorderFilled.displayName = "MonitorRecorderFilled";
export const MonitorRecorderFilledMetadata = { 
  id: "monitor-recorder_filled", 
...
export default MonitorRecorderFilled;
