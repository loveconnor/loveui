...
export interface TimerFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TimerFilled = React.forwardRef<SVGSVGElement, TimerFilledProps>(
