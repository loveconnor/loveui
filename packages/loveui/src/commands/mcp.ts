...
const LOVEUI_MCP_VERSION = "latest"
...
const CLIENTS = [
  {
    ...
    config: {
      mcpServers: {
        loveui: {
          command: "npx",
          args: [`love-ui@${LOVEUI_MCP_VERSION}`, "mcp"],
        },
      },
    },
  },
  ...
  },
  {
    ...
    config: {
      ...
      mcp: {
        loveui: {
          type: "local",
          command: ["npx", `love-ui@${LOVEUI_MCP_VERSION}`, "mcp"],
          enabled: true,
        },
      },
    },
...
const DEPENDENCIES = [`love-ui@${LOVEUI_MCP_VERSION}`]
  ...
  .action(async (opts, command) => {
    try {
      ...
      if (options.client === "codex") {
        ...
        logger.break()
        logger.log("To configure the Love UI MCP server in Codex:")
        logger.break()
        logger.log(
        ...
        logger.log()
        logger.info(`[mcp_servers.loveui]
command = "npx"
args = ["love-ui@${LOVEUI_MCP_VERSION}", "mcp"]`)
        logger.break()
