...
export interface EmojiHappyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EmojiHappyFilled = React.forwardRef<SVGSVGElement, EmojiHappyFilledProps>(
...
EmojiHappyFilled.displayName = "EmojiHappyFilled";
export const EmojiHappyFilledMetadata = { 
  id: "emoji-happy_filled", 
  baseId: "emoji-happy", 
  variant: "filled", 
  name: "Emoji Happy", 
  category: "app", 
