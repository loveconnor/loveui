...
export interface RefreshSquare2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RefreshSquare2Filled = React.forwardRef<SVGSVGElement, RefreshSquare2FilledProps>(
...
RefreshSquare2Filled.displayName = "RefreshSquare2Filled";
export const RefreshSquare2FilledMetadata = { 
  id: "refresh-square-2_filled", 
...
export default RefreshSquare2Filled;
