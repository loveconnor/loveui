...
export interface Brush2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Brush2Filled = React.forwardRef<SVGSVGElement, Brush2FilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M21.81 3.94009C20.5 7.21009 17.51 11.4801 14.66 14.2701C14.25 11.6901 12.19 9.67009 9.59003 9.31009C12.39 6.45009 16.69 3.42009 19.97 2.10009C20.55 1.88009 21.13 2.05009 21.49 2.41009C21.87 2.79009 22.05 3.36009 21.81 3.94009Z" fill="currentColor"/>
...
Brush2Filled.displayName = "Brush2Filled";
export const Brush2FilledMetadata = { 
  id: "brush-2_filled", 
  baseId: "brush-2", 
  variant: "filled", 
  name: "Brush 2", 
