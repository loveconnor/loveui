          ...
          >
            ...
            <div className="flex h-16 items-center justify-between gap-4 px-3 pt-1.5">
              <div className="min-w-0">
                ...
                <p className="mt-1 truncate text-sm font-medium text-muted-foreground">
                  Editorial indexes and article grids.
                </p>
              </div>
              <span className="shrink-0 text-sm font-medium text-muted-foreground">
                3 Blocks
          ...
          >
            ...
            <div className="flex h-16 items-center justify-between gap-4 px-3 pt-1.5">
              <div className="min-w-0">
                ...
                <p className="mt-1 truncate text-sm font-medium text-muted-foreground">
                  Connected app and tool sections.
                </p>
              </div>
              <span className="shrink-0 text-sm font-medium text-muted-foreground">
                5 Blocks
          ...
          >
            ...
            <div className="flex h-16 items-center justify-between gap-4 px-3 pt-1.5">
              <div className="min-w-0">
                ...
                <p className="mt-1 truncate text-sm font-medium text-muted-foreground">
                  Support sections with expandable answers.
                </p>
              </div>
              <span className="shrink-0 text-sm font-medium text-muted-foreground">
                5 Blocks
          ...
          >
            ...
            <div className="flex h-16 items-center justify-between gap-4 px-3 pt-1.5">
              <div className="min-w-0">
                ...
                <p className="mt-1 truncate text-sm font-medium text-muted-foreground">
                  Plan and subscription pricing sections.
                </p>
              </div>
              <span className="shrink-0 text-sm font-medium text-muted-foreground">
                4 Blocks
