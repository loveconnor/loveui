...
export interface RefreshLeftSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RefreshLeftSquareFilled = React.forwardRef<SVGSVGElement, RefreshLeftSquareFilledProps>(
...
RefreshLeftSquareFilled.displayName = "RefreshLeftSquareFilled";
export const RefreshLeftSquareFilledMetadata = { 
  id: "refresh-left-square_filled", 
...
export default RefreshLeftSquareFilled;
