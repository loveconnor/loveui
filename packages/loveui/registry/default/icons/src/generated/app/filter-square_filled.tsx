...
export interface FilterSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FilterSquareFilled = React.forwardRef<SVGSVGElement, FilterSquareFilledProps>(
...
FilterSquareFilled.displayName = "FilterSquareFilled";
export const FilterSquareFilledMetadata = { 
  id: "filter-square_filled", 
...
export default FilterSquareFilled;
