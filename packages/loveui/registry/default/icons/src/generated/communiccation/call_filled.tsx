...
export interface CallFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CallFilled = React.forwardRef<SVGSVGElement, CallFilledProps>(
...
export const CallFilledMetadata = { 
  id: "call_filled", 
  baseId: "call", 
  variant: "filled", 
  name: "Call", 
