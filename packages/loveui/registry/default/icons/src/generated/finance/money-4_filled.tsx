...
export interface Money4FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Money4Filled = React.forwardRef<SVGSVGElement, Money4FilledProps>(
...
Money4Filled.displayName = "Money4Filled";
export const Money4FilledMetadata = { 
  id: "money-4_filled", 
  baseId: "money-4", 
  variant: "filled", 
  name: "Money 4", 
