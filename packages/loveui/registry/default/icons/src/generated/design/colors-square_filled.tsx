...
export interface ColorsSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ColorsSquareFilled = React.forwardRef<SVGSVGElement, ColorsSquareFilledProps>(
...
ColorsSquareFilled.displayName = "ColorsSquareFilled";
export const ColorsSquareFilledMetadata = { 
  id: "colors-square_filled", 
...
export default ColorsSquareFilled;
