...
export interface EmptyWalletChangeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EmptyWalletChangeFilled = React.forwardRef<SVGSVGElement, EmptyWalletChangeFilledProps>(
...
EmptyWalletChangeFilled.displayName = "EmptyWalletChangeFilled";
export const EmptyWalletChangeFilledMetadata = { 
  id: "empty-wallet-change_filled", 
...
export default EmptyWalletChangeFilled;
