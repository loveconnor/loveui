...
export interface CommandSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CommandSquareFilled = React.forwardRef<SVGSVGElement, CommandSquareFilledProps>(
...
CommandSquareFilled.displayName = "CommandSquareFilled";
export const CommandSquareFilledMetadata = { 
  id: "command-square_filled", 
...
export default CommandSquareFilled;
