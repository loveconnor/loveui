...
export interface MessageEditFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MessageEditFilled = React.forwardRef<SVGSVGElement, MessageEditFilledProps>(
...
MessageEditFilled.displayName = "MessageEditFilled";
export const MessageEditFilledMetadata = { 
  id: "message-edit_filled", 
  baseId: "message-edit", 
  variant: "filled", 
  name: "Message Edit", 
  category: "message", 
...
export default MessageEditFilled;
