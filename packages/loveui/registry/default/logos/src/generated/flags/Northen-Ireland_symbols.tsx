...
export interface NorthenIrelandSymbolsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const NorthenIrelandSymbols = React.forwardRef<SVGSVGElement, NorthenIrelandSymbolsProps>(
...
NorthenIrelandSymbols.displayName = "NorthenIrelandSymbols";

export const NorthenIrelandSymbolsMetadata = {
  id: "Northen-Ireland_symbols",
...
export default NorthenIrelandSymbols;
