...
export interface NoteFavoriteFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const NoteFavoriteFilled = React.forwardRef<SVGSVGElement, NoteFavoriteFilledProps>(
...
NoteFavoriteFilled.displayName = "NoteFavoriteFilled";
export const NoteFavoriteFilledMetadata = { 
  id: "note-favorite_filled", 
...
export default NoteFavoriteFilled;
