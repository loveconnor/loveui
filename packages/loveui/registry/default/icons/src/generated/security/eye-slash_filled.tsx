...
export interface EyeSlashFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EyeSlashFilled = React.forwardRef<SVGSVGElement, EyeSlashFilledProps>(
...
<path d="M14.86 12.0001C14.86 13.5701 13.58 14.8601 12 14.8601C11.94 14.8601 11.89 14.8601 11.83 14.8401L14.84 11.8301C14.86 11.8901 14.86 11.9401 14.86 12.0001Z" fill="currentColor"/>
...
export const EyeSlashFilledMetadata = { 
  id: "eye-slash_filled", 
  baseId: "eye-slash", 
  variant: "filled", 
  name: "Eye Slash", 
