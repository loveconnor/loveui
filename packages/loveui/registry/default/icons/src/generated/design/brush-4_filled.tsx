...
export interface Brush4FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Brush4Filled = React.forwardRef<SVGSVGElement, Brush4FilledProps>(
