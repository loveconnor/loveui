		...
		<section className="mx-auto w-full max-w-5xl overflow-hidden pt-16">
			...
			<div className="relative z-10 flex max-w-2xl flex-col gap-5 px-4">
				...
				>
					...
					<span className="text-xs">new automation templates released</span>
				...
				>
					Your Team's Workflows, Automated End to End
				</h1>
				...
				>
					Orchestrate approvals, alerts, and handoffs <br /> with AI agents
					that understand your process.
				</p>
