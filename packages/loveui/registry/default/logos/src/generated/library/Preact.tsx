...
export interface PreactProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Preact = React.forwardRef<SVGSVGElement, PreactProps>(
