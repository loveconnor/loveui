 ...
 *         ../../apps/www/public/r/vectors-all.json
 */
...
const REGISTRY_NAME     = "love-ui/vectors";
 ...
 *   → registry/vectors/abstract/abstract-mark.tsx
 */
...
function main(): void {
  ...
  for (const icon of icons) {
    ...
    const item: RegistryItem = {
      ...
      type:                 "registry:ui",
      title:                icon.name,
      description:          `${icon.name} vector component`,
  ...
  // 4. vectors-all.json — install everything in one command (content embedded)
  ...
  const allItem: RegistryItem = {
    ...
    type:                 "registry:ui",
    title:                "All Vectors",
    description:          "Complete love-ui/vectors library — installs every vector.",
    dependencies:         [],
    devDependencies:      [],
    registryDependencies: [],
    files:                allFiles,
