...
export interface MoneySendFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MoneySendFilled = React.forwardRef<SVGSVGElement, MoneySendFilledProps>(
...
MoneySendFilled.displayName = "MoneySendFilled";
export const MoneySendFilledMetadata = { 
  id: "money-send_filled", 
  baseId: "money-send", 
  variant: "filled", 
  name: "Money Send", 
  category: "finance", 
