...
export interface AirpodsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AirpodsFilled = React.forwardRef<SVGSVGElement, AirpodsFilledProps>(
...
<path d="M9.25 18.8798V21.9998C9.25 22.4098 8.91 22.7498 8.5 22.7498C8.09 22.7498 7.75 22.4098 7.75 21.9998V18.7798C8 18.9198 8.3 18.9998 8.61 18.9998C8.83 18.9998 9.05 18.9598 9.25 18.8798Z" fill="currentColor"/>
<path d="M16.25 18.7798V21.9998C16.25 22.4098 15.91 22.7498 15.5 22.7498C15.09 22.7498 14.75 22.4098 14.75 21.9998V18.8798C14.95 18.9598 15.17 18.9998 15.39 18.9998C15.7 18.9998 16 18.9198 16.25 18.7798Z" fill="currentColor"/>
    </svg>
  )
);
AirpodsFilled.displayName = "AirpodsFilled";
export const AirpodsFilledMetadata = { 
  id: "airpods_filled", 
  baseId: "airpods", 
  variant: "filled", 
  name: "Airpods", 
