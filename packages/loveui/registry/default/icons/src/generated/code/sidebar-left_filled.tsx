...
export interface SidebarLeftFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SidebarLeftFilled = React.forwardRef<SVGSVGElement, SidebarLeftFilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M2 7.81003V16.19C2 17.68 2.36 18.92 3.05 19.87C3.34 20.29 3.71 20.66 4.13 20.95C4.95 21.55 5.99 21.9 7.22 21.98V2.03003C3.94 2.24003 2 4.37003 2 7.81003Z" fill="currentColor"/>
...
export const SidebarLeftFilledMetadata = { 
  id: "sidebar-left_filled", 
  baseId: "sidebar-left", 
  variant: "filled", 
  name: "Sidebar Left", 
  category: "code", 
