...
export interface KanbanFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const KanbanFilled = React.forwardRef<SVGSVGElement, KanbanFilledProps>(
...
KanbanFilled.displayName = "KanbanFilled";
export const KanbanFilledMetadata = { 
  id: "kanban_filled", 
  baseId: "kanban", 
  variant: "filled", 
  name: "Kanban", 
