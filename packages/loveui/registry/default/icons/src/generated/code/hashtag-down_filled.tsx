...
export interface HashtagDownFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HashtagDownFilled = React.forwardRef<SVGSVGElement, HashtagDownFilledProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M10.08 11.8299H11.73L11.92 10.1699H10.27L10.08 11.8299Z" fill="currentColor"/>
...
HashtagDownFilled.displayName = "HashtagDownFilled";
export const HashtagDownFilledMetadata = { 
  id: "hashtag-down_filled", 
  baseId: "hashtag-down", 
  variant: "filled", 
  name: "Hashtag Down", 
  category: "code", 
...
export default HashtagDownFilled;
