...
export interface MoneyChangeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MoneyChangeFilled = React.forwardRef<SVGSVGElement, MoneyChangeFilledProps>(
...
MoneyChangeFilled.displayName = "MoneyChangeFilled";
export const MoneyChangeFilledMetadata = { 
  id: "money-change_filled", 
  baseId: "money-change", 
  variant: "filled", 
  name: "Money Change", 
  category: "finance", 
...
export default MoneyChangeFilled;
