...
export interface Strongbox2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Strongbox2Filled = React.forwardRef<SVGSVGElement, Strongbox2FilledProps>(
...
Strongbox2Filled.displayName = "Strongbox2Filled";
export const Strongbox2FilledMetadata = { 
  id: "strongbox-2_filled", 
  baseId: "strongbox-2", 
  variant: "filled", 
  name: "Strongbox 2", 
  category: "finance", 
...
export default Strongbox2Filled;
