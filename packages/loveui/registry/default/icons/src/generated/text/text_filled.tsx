...
export interface TextFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TextFilled = React.forwardRef<SVGSVGElement, TextFilledProps>(
...
export const TextFilledMetadata = { 
  id: "text_filled", 
  baseId: "text", 
  variant: "filled", 
  name: "Text", 
