...
export interface MenuBoardFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MenuBoardFilled = React.forwardRef<SVGSVGElement, MenuBoardFilledProps>(
...
export default MenuBoardFilled;
