...
export interface AttachSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AttachSquareFilled = React.forwardRef<SVGSVGElement, AttachSquareFilledProps>(
...
AttachSquareFilled.displayName = "AttachSquareFilled";
export const AttachSquareFilledMetadata = { 
  id: "attach-square_filled", 
...
export default AttachSquareFilled;
