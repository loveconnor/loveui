...
export interface CourthouseFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CourthouseFilled = React.forwardRef<SVGSVGElement, CourthouseFilledProps>(
...
export default CourthouseFilled;
