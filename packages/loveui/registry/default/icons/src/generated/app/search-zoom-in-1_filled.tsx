...
export interface SearchZoomIn1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SearchZoomIn1Filled = React.forwardRef<SVGSVGElement, SearchZoomIn1FilledProps>(
...
SearchZoomIn1Filled.displayName = "SearchZoomIn1Filled";
export const SearchZoomIn1FilledMetadata = { 
  id: "search-zoom-in-1_filled", 
...
export default SearchZoomIn1Filled;
