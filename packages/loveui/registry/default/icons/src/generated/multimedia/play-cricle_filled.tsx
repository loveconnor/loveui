...
export interface PlayCricleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PlayCricleFilled = React.forwardRef<SVGSVGElement, PlayCricleFilledProps>(
...
<path d="M4.93007 19.8201C4.74007 19.8201 4.55007 19.7501 4.40007 19.6001C0.210068 15.4101 0.210068 8.59012 4.40007 4.40012C4.69007 4.11012 5.17007 4.11012 5.46007 4.40012C5.75007 4.69012 5.75007 5.17012 5.46007 5.46012C1.85007 9.07012 1.85007 14.9401 5.46007 18.5401C5.75007 18.8301 5.75007 19.3101 5.46007 19.6001C5.31007 19.7501 5.12007 19.8201 4.93007 19.8201Z" fill="currentColor"/>
...
PlayCricleFilled.displayName = "PlayCricleFilled";
export const PlayCricleFilledMetadata = { 
  id: "play-cricle_filled", 
  baseId: "play-cricle", 
  variant: "filled", 
  name: "Play Cricle", 
  category: "multimedia", 
...
export default PlayCricleFilled;
