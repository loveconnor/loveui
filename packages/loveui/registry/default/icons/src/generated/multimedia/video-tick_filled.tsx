...
export interface VideoTickFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VideoTickFilled = React.forwardRef<SVGSVGElement, VideoTickFilledProps>(
...
VideoTickFilled.displayName = "VideoTickFilled";
export const VideoTickFilledMetadata = { 
  id: "video-tick_filled", 
  baseId: "video-tick", 
  variant: "filled", 
  name: "Video Tick", 
  category: "multimedia", 
...
export default VideoTickFilled;
