...
export interface FormatCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FormatCircleFilled = React.forwardRef<SVGSVGElement, FormatCircleFilledProps>(
...
FormatCircleFilled.displayName = "FormatCircleFilled";
export const FormatCircleFilledMetadata = { 
  id: "format-circle_filled", 
...
export default FormatCircleFilled;
