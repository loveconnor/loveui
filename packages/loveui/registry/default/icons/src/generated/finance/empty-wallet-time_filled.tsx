...
export interface EmptyWalletTimeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EmptyWalletTimeFilled = React.forwardRef<SVGSVGElement, EmptyWalletTimeFilledProps>(
...
EmptyWalletTimeFilled.displayName = "EmptyWalletTimeFilled";
export const EmptyWalletTimeFilledMetadata = { 
  id: "empty-wallet-time_filled", 
...
export default EmptyWalletTimeFilled;
