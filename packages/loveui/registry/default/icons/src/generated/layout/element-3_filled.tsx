...
export interface Element3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Element3Filled = React.forwardRef<SVGSVGElement, Element3FilledProps>(
...
Element3Filled.displayName = "Element3Filled";
export const Element3FilledMetadata = { 
  id: "element-3_filled", 
  baseId: "element-3", 
  variant: "filled", 
  name: "Element 3", 
