...
export interface SearchZoomInFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SearchZoomInFilled = React.forwardRef<SVGSVGElement, SearchZoomInFilledProps>(
...
SearchZoomInFilled.displayName = "SearchZoomInFilled";
export const SearchZoomInFilledMetadata = { 
  id: "search-zoom-in_filled", 
...
export default SearchZoomInFilled;
