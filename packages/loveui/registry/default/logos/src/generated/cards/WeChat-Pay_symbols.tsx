...
export interface WeChatPaySymbolsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const WeChatPaySymbols = React.forwardRef<SVGSVGElement, WeChatPaySymbolsProps>(
...
WeChatPaySymbols.displayName = "WeChatPaySymbols";

export const WeChatPaySymbolsMetadata = {
  id: "WeChat-Pay_symbols",
  baseId: "WeChat-Pay",
  variant: "symbols",
  name: "WeChat Pay",
  category: "cards",
...
export default WeChatPaySymbols;
