...
export interface ActivityFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ActivityFilled = React.forwardRef<SVGSVGElement, ActivityFilledProps>(
...
export const ActivityFilledMetadata = { 
  id: "activity_filled", 
  baseId: "activity", 
  variant: "filled", 
  name: "Activity", 
