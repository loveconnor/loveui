...
export interface RefreshRightSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RefreshRightSquareFilled = React.forwardRef<SVGSVGElement, RefreshRightSquareFilledProps>(
...
RefreshRightSquareFilled.displayName = "RefreshRightSquareFilled";
export const RefreshRightSquareFilledMetadata = { 
  id: "refresh-right-square_filled", 
...
export default RefreshRightSquareFilled;
