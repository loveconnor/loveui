...
export interface MoreSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MoreSquareFilled = React.forwardRef<SVGSVGElement, MoreSquareFilledProps>(
...
MoreSquareFilled.displayName = "MoreSquareFilled";
export const MoreSquareFilledMetadata = { 
  id: "more-square_filled", 
  baseId: "more-square", 
  variant: "filled", 
  name: "More Square", 
  category: "app", 
...
export default MoreSquareFilled;
