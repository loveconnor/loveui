...
export interface OmegaSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const OmegaSquareFilled = React.forwardRef<SVGSVGElement, OmegaSquareFilledProps>(
...
OmegaSquareFilled.displayName = "OmegaSquareFilled";
export const OmegaSquareFilledMetadata = { 
  id: "omega-square_filled", 
  baseId: "omega-square", 
  variant: "filled", 
  name: "Omega Square", 
  category: "design", 
...
export default OmegaSquareFilled;
