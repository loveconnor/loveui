...
export interface TagUserFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TagUserFilled = React.forwardRef<SVGSVGElement, TagUserFilledProps>(
...
TagUserFilled.displayName = "TagUserFilled";
export const TagUserFilledMetadata = { 
  id: "tag-user_filled", 
  baseId: "tag-user", 
  variant: "filled", 
  name: "Tag User", 
