...
export interface UserTickFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const UserTickFilled = React.forwardRef<SVGSVGElement, UserTickFilledProps>(
...
UserTickFilled.displayName = "UserTickFilled";
export const UserTickFilledMetadata = { 
  id: "user-tick_filled", 
  baseId: "user-tick", 
  variant: "filled", 
  name: "User Tick", 
