...
export interface FavoriteChartFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FavoriteChartFilled = React.forwardRef<SVGSVGElement, FavoriteChartFilledProps>(
...
FavoriteChartFilled.displayName = "FavoriteChartFilled";
export const FavoriteChartFilledMetadata = { 
  id: "favorite-chart_filled", 
...
export default FavoriteChartFilled;
