...
export interface EmojiNormalFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EmojiNormalFilled = React.forwardRef<SVGSVGElement, EmojiNormalFilledProps>(
...
EmojiNormalFilled.displayName = "EmojiNormalFilled";
export const EmojiNormalFilledMetadata = { 
  id: "emoji-normal_filled", 
  baseId: "emoji-normal", 
  variant: "filled", 
  name: "Emoji Normal", 
  category: "app", 
...
export default EmojiNormalFilled;
