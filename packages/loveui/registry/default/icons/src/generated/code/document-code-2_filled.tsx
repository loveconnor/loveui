...
export interface DocumentCode2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DocumentCode2Filled = React.forwardRef<SVGSVGElement, DocumentCode2FilledProps>(
...
DocumentCode2Filled.displayName = "DocumentCode2Filled";
export const DocumentCode2FilledMetadata = { 
  id: "document-code-2_filled", 
...
export default DocumentCode2Filled;
