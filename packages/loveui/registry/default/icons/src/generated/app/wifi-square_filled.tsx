...
export interface WifiSquareFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const WifiSquareFilled = React.forwardRef<SVGSVGElement, WifiSquareFilledProps>(
...
WifiSquareFilled.displayName = "WifiSquareFilled";
export const WifiSquareFilledMetadata = { 
  id: "wifi-square_filled", 
  baseId: "wifi-square", 
  variant: "filled", 
  name: "Wifi Square", 
  category: "app", 
...
export default WifiSquareFilled;
