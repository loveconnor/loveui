...
export interface DocumentTextFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DocumentTextFilled = React.forwardRef<SVGSVGElement, DocumentTextFilledProps>(
...
export const DocumentTextFilledMetadata = { 
  id: "document-text_filled", 
