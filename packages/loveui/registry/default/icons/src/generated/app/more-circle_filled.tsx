...
export interface MoreCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MoreCircleFilled = React.forwardRef<SVGSVGElement, MoreCircleFilledProps>(
...
export const MoreCircleFilledMetadata = { 
  id: "more-circle_filled", 
  baseId: "more-circle", 
  variant: "filled", 
  name: "More Circle", 
  category: "app", 
