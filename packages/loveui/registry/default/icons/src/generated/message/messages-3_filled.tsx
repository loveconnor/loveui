...
export interface Messages3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Messages3Filled = React.forwardRef<SVGSVGElement, Messages3FilledProps>(
...
Messages3Filled.displayName = "Messages3Filled";
export const Messages3FilledMetadata = { 
  id: "messages-3_filled", 
  baseId: "messages-3", 
  variant: "filled", 
  name: "Messages 3", 
  category: "message", 
...
export default Messages3Filled;
