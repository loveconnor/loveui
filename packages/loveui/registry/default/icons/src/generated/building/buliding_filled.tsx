...
export interface BulidingFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BulidingFilled = React.forwardRef<SVGSVGElement, BulidingFilledProps>(
...
BulidingFilled.displayName = "BulidingFilled";
export const BulidingFilledMetadata = { 
  id: "buliding_filled", 
  baseId: "buliding", 
  variant: "filled", 
  name: "Buliding", 
