...
export interface TransactionMinusFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TransactionMinusFilled = React.forwardRef<SVGSVGElement, TransactionMinusFilledProps>(
...
TransactionMinusFilled.displayName = "TransactionMinusFilled";
export const TransactionMinusFilledMetadata = { 
  id: "transaction-minus_filled", 
...
export default TransactionMinusFilled;
