...
export interface DocumentFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DocumentFilled = React.forwardRef<SVGSVGElement, DocumentFilledProps>(
...
export const DocumentFilledMetadata = { 
  id: "document_filled", 
  baseId: "document", 
  variant: "filled", 
  name: "Document", 
