...
export interface CpuChargeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CpuChargeFilled = React.forwardRef<SVGSVGElement, CpuChargeFilledProps>(
...
CpuChargeFilled.displayName = "CpuChargeFilled";
export const CpuChargeFilledMetadata = { 
  id: "cpu-charge_filled", 
  baseId: "cpu-charge", 
  variant: "filled", 
  name: "Cpu Charge", 
  category: "device", 
...
export default CpuChargeFilled;
