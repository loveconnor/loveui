...
export interface Hierarchy2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Hierarchy2Filled = React.forwardRef<SVGSVGElement, Hierarchy2FilledProps>(
...
Hierarchy2Filled.displayName = "Hierarchy2Filled";
export const Hierarchy2FilledMetadata = { 
  id: "hierarchy-2_filled", 
  baseId: "hierarchy-2", 
  variant: "filled", 
  name: "Hierarchy 2", 
  category: "code", 
...
export default Hierarchy2Filled;
