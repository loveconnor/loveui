...
export interface MoneyAddFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MoneyAddFilled = React.forwardRef<SVGSVGElement, MoneyAddFilledProps>(
...
MoneyAddFilled.displayName = "MoneyAddFilled";
export const MoneyAddFilledMetadata = { 
  id: "money-add_filled", 
  baseId: "money-add", 
  variant: "filled", 
  name: "Money Add", 
